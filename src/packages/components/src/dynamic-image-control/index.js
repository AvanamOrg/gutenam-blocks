...
class DynamicImageControl extends Component {
	...
	render() {
		...
		return (
			<div className="bsb-dynamic-image-sidebar-wrap bsb-dynamic-background-sidebar-wrap">
				<Button
					className="bsb-dynamic-image-sidebar bsb-dynamic-background-sidebar"
					isTertiary
					icon={ icons.dynamic }
					...
					aria-haspopup="true"
					aria-expanded={ open }
					label={  __( 'Dynamic Image', 'gutenam-blocks' ) }
					showTooltip={ true }
				/>
				{ open && (
					<Popover
					...
					>
						<div className="bsb-dynamic-popover-inner-wrap">
							<div className="bsb-pro-notice">
								<h2>{ __( 'Dynamic Image', 'gutenam-blocks' ) } </h2>
...
export default withFilters( 'base.ImageDynamicControl' )( DynamicImageControl );
