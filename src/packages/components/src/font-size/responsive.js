 ...
 */
 ...
 import { capitalizeFirstLetter, FONT_SIZES_MAP } from '@base/helpers';
 ...
 export default function ResponsiveFontSizeControl( {
	 ...
	 return [
		 onChange && onChangeTablet && onChangeMobile && (
			 <div ref={ ref } className={ 'components-base-control bsb-responsive-font-size-control base-font-size-control' }>
					<div
						className={ 'base-font-size-control__header base-component__header' }
					>
					 { label && (
						 <div className="base-component__header__title base-font-size__title">
