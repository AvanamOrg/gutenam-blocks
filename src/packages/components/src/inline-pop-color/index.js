 ...
 export default function InlinePopColorControl( {
	...
	const renderToggleComponent = () => ( {
		...
		return (
			<ToolbarGroup>
				<Button
					className="components-toolbar__control bsb-colors-selector__toggle"
					label={ label }
					onClick={ onToggle }
					onKeyDown={ openOnArrowDown }
					icon={
						<div className="bsb-colors-selector__icon-container">
							<div
								className={ 'bsb-colors-selector__state-selection' }
	...
	return (
		<Dropdown
			placement="top"
			className="bsb-colors-selector components-dropdown-menu components-toolbar new-base-advanced-colors"
			contentClassName="block-library-colors-selector__popover bst-popover-color base-pop-color-popover"
			//renderToggle={ renderToggleComponent() }
			renderToggle={ ( { isOpen, onToggle } ) => (
				<>
					<Button
						className="components-toolbar__control components-dropdown-menu__toggle bsb-colors-selector__toggle"
						label={ label }
						tooltip={ label }
						icon={
							<div className="bsb-colors-selector__icon-container">
