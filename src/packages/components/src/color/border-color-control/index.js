...
export default function BorderColorControls( {
	...
	return (
		<div ref={ containerRef } className={ `components-base-control bsb-border-color-control ${ '' !== className ? ' ' + className : '' }` }>
				...
				{ realOnChangeControl && (
					<div className="base-units base-locked">
						{ realControl !== 'individual' ? (
							<Tooltip text={ __( 'Individual', 'gutenam-blocks' ) }>
								<Button
									className="is-single"
									isSmall
							...
							<Tooltip text={ __( 'Linked', 'gutenam-blocks' ) }>
								<Button
									className="is-single"
									isSmall
			...
			<div className="base-controls-content-border">
				{ realControl !== 'individual' && (
					<Fragment>
						<PopColorControl
				...
				{ realControl === 'individual' && (
					<div className="bst-border-color-array-control">
						<PopColorControl
							label={ firstIcon }
							swatchLabel={ swatchLabel ? swatchLabel : '' }
							value={ ( value && value[ 0 ] ? value[ 0 ] : '' ) }
