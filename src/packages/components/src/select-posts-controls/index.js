...
import { fetchJson } from '@base/helpers';

import { addQueryArgs } from '@wordpress/url';
import { Component } from '@wordpress/element';

class BaseSelectPosts extends Component {
	constructor() {
		super( ...arguments );
		this.state = {
			options: [],
		...
		return (
			<div className="term-select-form-row">
				...
				<Select
					...
					classNamePrefix="bst-tax-select"
...
export default BaseSelectPosts;
