...
const GradientPositionPicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<div className={ `components-base-control base-gradient-position-control` }>
				...
				>
					<FlexItem>
						<label className="base-gradient-position__label">{ __( 'Position', 'gutenam-blocks' ) }</label>
					</FlexItem>
				</Flex>
				{ positionType === 'position-keyword' && (
					<div className={ 'base-controls-content' }>
						<SelectControl
							...
							// label={ __( 'Position', 'gutenam-blocks' ) }
							// labelPosition="top"
						...
						<Button
							...
							label={ __( 'Set custom position', 'gutenam-blocks' ) }
							icon={ settings }
				...
				{ positionType !== 'position-keyword' && (
					<div className={ 'base-controls-content' }>
						...
						<Button
							className={'base-control-toggle-advanced only-icon'}
							label={ __( 'Set standard position', 'gutenam-blocks' ) }
							icon={ settings }
...
const GradientShapePicker = ( { gradientAST, hasGradient, onChange } ) => {
	...
	return (
		<SelectControl
			...
			label={ __( 'Shape', 'gutenam-blocks' ) }
			labelPosition="top"
			onChange={ onShapeChange }
			options={ [
				{ value: 'ellipse', label: __( 'Ellipse', 'gutenam-blocks'  ) },
				{ value: 'circle', label: __( 'Circle', 'gutenam-blocks'  ) },
			] }
