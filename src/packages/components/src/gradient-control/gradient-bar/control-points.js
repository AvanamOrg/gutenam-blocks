...
function CustomColorPickerDropdown( {
	...
	return (
		<CustomDropdown
			contentClassName="components-color-palette__custom-color-dropdown-content base-pop-color-popover"
			...
			ignoreMarkerPosition !== initialPosition && (
				<GradientColorPickerDropdown
					...
					renderContent={ ( { onClose } ) => (
						<div className="base-pop-gradient-color-picker">
							{ ! disableCustomColors && (
								<ColorPicker
									color={ pointColor }
									onChange={ ( color ) => {
										...
										return (
											<div key={ color } className="base-color-palette__item-wrapper">
												<Tooltip
													...
													<Button
														type="button"
														className={ `base-color-palette__item ${ ( isActive || isLinked ? 'is-active' : '' ) }` }
														style={ style }
														onClick={ () => {
