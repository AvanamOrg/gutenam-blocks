	...
	updateSuggestions( value = '' ) {
		...
		return (
			<Fragment>
				{ additionalControls && isSettingsExpanded && (
					<div className="bsb-link-control-additional-controls">
						{ advancedOptions }
					</div>
				) }
			</Fragment>
	 ...
	 renderControl() {
		 const {
			 ...
			 isFullWidth,
			 instanceId,
			 placeholder = __( 'Paste URL or type to search', 'gutenam-blocks' ),
			 url = '',
			 attributes,
			 dynamicAttribute = '',
			 isSettingsExpanded,
		 ...
		 const controlProps = {
			 ...
			 className: 'bsb-search-selection-name',
		 };

		 const inputProps = {
			 value: this.state.search || url,
			 required: true,
			 className: 'bsb-search-selection-input',
			 type: 'text',
			 ...
			 role: 'combobox',
			 'aria-label': __( 'URL Input or Search', 'gutenam-blocks' ),
		 ...
		 return (
			<Fragment>
				<div className="bsb-side-link-control-inner-row">
					{ url && ! isEditing && (
						<div className={ 'bsb-search-selection-name' }>
							{ applyFilters(
								'base.linkDisplay',
								<Fragment>
					...
					{ ( ! url || isEditing ) && (
						<BaseControl { ...controlProps }>
							<div className="bsb-search-url-input">
								<input { ...inputProps } />
							</div>
							{ loading && <Spinner /> }
							{ allowClear && ! this.state.search && url && (
								<Button
									className="bsb-search-url-clear"
									icon={ cancelCircleFilled }
									label={ __( 'Clear', 'gutenam-blocks' ) }
									onClick={ () => {
										this.props.onChange( '', '' );
										this.setState( {
											isEditing: false,
							...
							<Button
								className="bsb-search-url-submit"
								icon={ keyboardReturn }
								label={ __( 'Submit', 'gutenam-blocks' ) }
								onClick={ () => {
					...
					{ additionalControls && (
						<Button
							className="bsb-link-settings-toggle"
							icon={ chevronDown }
	 ...
	 renderSuggestions() {
		 ...
		 if (
			 ...
			 return (
				 <div className="bsb-search-selection-list">
					 <div
						 { ...suggestionsListProps }
						 className={ classnames(
							 'bsb-search-selection-suggestions',
					 ...
					 >
						 { suggestions.map( ( suggestion, index ) => (
							 <Button
								 ...
								 key={ suggestion.id }
								 className={ classnames(
									 'bsb-search-selection-suggestion',
									 {
										 'is-selected':
							 ...
							 >
								 ...
								 <span className="bsb-search-selection-search-item-header">
								 	<span className="bsb-search-selection-search-item-title">
										<TextHighlight
									...
									<span
										...
										className="bsb-search-selection-search-item-info"
									>
										{ ! directLinkEntryTypes.includes( suggestion.type.toLowerCase() ) &&
											( filterURLForDisplay(
								 ...
								 <span className="bsb-search-selection-search-item-type">
