...
export class ImageEdit extends Component {
	...
	render() {
		...
		const getInspectorControls = () => (
			<InspectorControls>
				<BasePanelBody title={ __( 'Image settings' ) } panelName={ 'bsb-image-image-settings' } />
				<BasePanelBody
					style={ styles.panelBody }
					panelName={ 'bsb-image-settings-style' }
				>
					<BlockStyles clientId={ clientId } url={ url } />
				</BasePanelBody>
				<BasePanelBody panelName={ 'bsb-image-size' }>
				...
				<BasePanelBody
					...
					panelName={ 'bsb-image-featured-image' }
				>
					{ canImageBeFeatured &&
