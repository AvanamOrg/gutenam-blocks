 ...
 */
const btadvancedbuttonUniqueIDs = [];

function BaseAdvancedButton( props ) {
	...
	useEffect( () => {
		if ( !uniqueID ) {
			const oldBlockConfig = base_blocks_params.config[ 'base/advancedbtn' ];
			const blockConfigObject = ( base_blocks_params.configuration ? JSON.parse( base_blocks_params.configuration ) : [] );
			if ( blockConfigObject[ 'base/advancedbtn' ] !== undefined && typeof blockConfigObject[ 'base/advancedbtn' ] === 'object' ) {
				Object.keys( blockConfigObject[ 'base/advancedbtn' ] ).map( ( attribute ) => {
					if ( attribute === 'btns' ) {
						attributes[ attribute ][0] = {...attributes[ attribute ][0], ...blockConfigObject[ 'base/advancedbtn' ][ attribute ][0] };
					} else {
						attributes[ attribute ] = blockConfigObject[ 'base/advancedbtn' ][ attribute ];
					}
				} );
			...
			btadvancedbuttonUniqueIDs.push( '_' + clientId.substr( 2, 9 ) );
		} else if ( btadvancedbuttonUniqueIDs.includes( uniqueID ) ) {
			if( uniqueID !== '_' + clientId.substr( 2, 9 ) ) {
				setAttributes( { uniqueID: '_' + clientId.substr( 2, 9 ) } );
				btadvancedbuttonUniqueIDs.push( '_' + clientId.substr( 2, 9 ) );
			}
		} else {
			btadvancedbuttonUniqueIDs.push( uniqueID );
		}
		const blockSettings = ( base_blocks_params.settings ? JSON.parse( base_blocks_params.settings ) : {} );
	...
	const blockConfigObject = ( base_blocks_params.configuration ? JSON.parse( base_blocks_params.configuration ) : [] );
	if ( blockConfigObject[ 'base/advancedbtn' ] !== undefined && typeof blockConfigObject[ 'base/advancedbtn' ] === 'object' && undefined !== blockConfigObject[ 'base/advancedbtn' ][ 'btns' ] ) {
		defaultBtnAttributes[0] = {...defaultBtns[0], ...blockConfigObject[ 'base/advancedbtn' ][ 'btns' ][0] };
	}
	...
	const previewMarginLeft = getPreviewSize( getPreviewDevice, ( undefined !== margin && undefined !== margin[ 0 ] && undefined !== margin[ 0 ].desk && '' !== margin[ 0 ].desk[ 3 ] ? margin[ 0 ].desk[ 3 ] : '' ), ( undefined !== margin && undefined !== margin[ 0 ] && undefined !== margin[ 0 ].tablet && '' !== margin[ 0 ].tablet[ 3 ] ? margin[ 0 ].tablet[ 3 ] : '' ), ( undefined !== margin && undefined !== margin[ 0 ] && undefined !== margin[ 0 ].mobile && '' !== margin[ 0 ].mobile[ 3 ] ? margin[ 0 ].mobile[ 3 ] : '' ) );
	...
	const renderBtns = ( index ) => {
		...
		if ( undefined !== btns[ index ].backgroundType && 'gradient' === btns[ index ].backgroundType ) {
			btnGrad = ( 'transparent' === btns[ index ].background || undefined === btns[ index ].background ? 'rgba(255,255,255,0)' : BaseColorOutput( btns[ index ].background, ( btns[ index ].backgroundOpacity !== undefined ? btns[ index ].backgroundOpacity : 1 ) ) );
			btnGrad2 = ( undefined !== btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] && '' !== btns[ index ].gradient[ 0 ] ? BaseColorOutput( btns[ index ].gradient[ 0 ], ( undefined !== btns[ index ].gradient && btns[ index ].gradient[ 1 ] !== undefined ? btns[ index ].gradient[ 1 ] : 1 ) ) : BaseColorOutput( '#999999', ( undefined !== btns[ index ].gradient && btns[ index ].gradient[ 1 ] !== undefined ? btns[ index ].gradient[ 1 ] : 1 ) ) );
			...
			btnbg = ( 'transparent' === btns[ index ].background || undefined === btns[ index ].background ? undefined : BaseColorOutput( btns[ index ].background, ( btns[ index ].backgroundOpacity !== undefined ? btns[ index ].backgroundOpacity : 1 ) ) );
		}
		//const ariaLabel = sprintf( __( 'Button %1$d of %2$d', 'gutenam-blocks' ), ( index + 1 ), btns.length );
		const ariaLabel = __( 'Button', 'gutenam-blocks' ) + ' ' + ( index + 1 ) + ' ' + __( 'Settings', 'gutenam-blocks' );
		const moveable = ( index === 0 && ( ( index + 1 ) === btns.length ) ? false : true );
		const btnClassName = classnames( {
			'bst-button'                                                                        : true,
			[ `bst-button-${index}` ]                                                           : true,
			...
			[ `bsb-btn-global-${btns[ index ].inheritStyles}` ]                                 : btns[ index ].inheritStyles,
			'wp-block-button__link'                                                            : btns[ index ].inheritStyles && 'inherit' === btns[ index ].inheritStyles,
			[ `bsb-btn-has-icon` ]                                                              : btns[ index ].icon,
		...
		const leftBtnMargin = getPreviewSize( getPreviewDevice, ( undefined !== btns[ index ].margin && undefined !== btns[ index ].margin[ 3 ] && '' !== btns[ index ].margin[ 3 ] ? btns[ index ].margin[ 3 ] : '' ), ( undefined !== btns[ index ].tabletMargin && undefined !== btns[ index ].tabletMargin[ 3 ] && '' !== btns[ index ].tabletMargin[ 3 ] ? btns[ index ].tabletMargin[ 3 ] : '' ), ( undefined !== btns[ index ].mobileMargin && undefined !== btns[ index ].mobileMargin[ 3 ] && '' !== btns[ index ].mobileMargin[ 3 ] ? btns[ index ].mobileMargin[ 3 ] : '' ) );
		const previewFixedWidth = getPreviewSize( getPreviewDevice, ( btns[ index ].width && undefined !== btns[ index ].width[ 0 ] ? btns[ index ].width[ 0 ] : undefined ), ( btns[ index ].width && undefined !== btns[ index ].width[ 1 ] ? btns[ index ].width[ 1 ] : undefined ), ( btns[ index ].width && undefined !== btns[ index ].width[ 2 ] ? btns[ index ].width[ 2 ] : undefined ) );
		...
		return (
			...
			>
					<span className={`bst-button-wrap bst-btn-${index}-action bst-btn-svg-show-${( !btns[ index ].iconHover ? 'always' : 'hover' )}`}>
						<span className={btnClassName} style={{
							background   : ( undefined !== btnbg ? btnbg : undefined ),
							color        : ( undefined !== btns[ index ].color ? BaseColorOutput( btns[ index ].color ) : undefined ),
							...
							borderColor  : ( undefined === btns[ index ].border ? '#555555' : BaseColorOutput( btns[ index ].border, ( btns[ index ].borderOpacity !== undefined ? btns[ index ].borderOpacity : 1 ) ) ),
							...
							{/* { applyFilters( 'base.dynamicContent', <RichText
								tagName="div"
								...
								allowedFormats={ applyFilters( 'base.whitelist_richtext_formats', [ 'core/bold', 'core/italic', 'core/strikethrough', 'toolset/inline-field' ], 'base/advancedbtn' ) }
				...
				{isButtonSelected && (
					<Fragment>
						<div className="base-blocks-button-item-controls base-blocks-button-item__move-menu">
							...
							{moveable && !lockBtnCount && (
								<DropdownMenu
									className="block-editor-block-settings-menu base-blocks-button-item__move-menu_item"
									icon={code}
									label={__( 'Move Button', 'gutenam-blocks' )}
									...
									{( { onClose } ) => (
										<Fragment>
											<MenuGroup>
												<MenuItem
													icon={chevronLeft}
													onClick={ () => { onClose; onMoveBackward( index ) } }
													disabled={index === 0}
													label={__( 'Move Left', 'gutenam-blocks' )}
												>
													{__( 'Move Left', 'gutenam-blocks' )}
												</MenuItem>
												<MenuItem
													icon={chevronRight}
													onClick={ () => { onClose; onMoveForward( index ) } }
													disabled={( index + 1 ) === btns.length}
													label={__( 'Move Right', 'gutenam-blocks' )}
												>
													{__( 'Move Right', 'gutenam-blocks' )}
												</MenuItem>
											</MenuGroup>
										</Fragment>
									)}
						...
						{ !lockBtnCount && (
							<div className="base-blocks-button-item-controls base-blocks-button-item__inline-menu">
								<Button
									icon={pages}
									onClick={ () => onDuplicateButton( index )}
									className="base-blocks-button-item__duplicate"
									label={__( 'Duplicate Button', 'gutenam-blocks' )}
									disabled={!isButtonSelected}
								/>
								<Button
									icon={close}
									onClick={ () => onRemoveButton( index )}
									className="base-blocks-button-item__remove"
									label={__( 'Remove Button', 'gutenam-blocks' )}
	...
	const buttonStyleOptions = [
		{ key: '', name: __( 'Default', 'gutenam-blocks' ) },
		{ key: 'inherit', name: __( 'Theme', 'gutenam-blocks' ) },
	...
	const blockToolControls = ( index ) => {
		const isButtonSelected = ( isSelected && selectedButton === index && base_blocks_params.dynamic_enabled );
		if ( !isButtonSelected ) {
			return;
		}
	...
	const tabControls = ( index ) => {
		...
		return (
			<BasePanelBody
				title={__( 'Button', 'gutenam-blocks' ) + ' ' + ( index + 1 ) + ' ' + __( 'Settings', 'gutenam-blocks' )}
				initialOpen={false}
				opened={( true === isButtonSelected ? true : undefined )}
				panelName={'bsb-adv-btn-' + index}
			>
				<Fragment>
					<h2 className="side-h2-label">{__( 'Button Inherit Styles', 'gutenam-blocks' )}</h2>
					<ButtonGroup className="bst-style-btn-group bsb-button-global-styles" aria-label={__( 'Button Global Styles', 'gutenam-blocks' )}>
					...
					<Fragment>
						<ResponsiveRangeControls
							...
							onChangeTablet={( value ) => {
								saveArrayUpdate( { responsiveSize: [ value, ( undefined !== btns[ index ].responsiveSize && undefined !== btns[ index ].responsiveSize[ 1 ] ? btns[ index ].responsiveSize[ 1 ] : '' ) ] }, index );
							}}
							mobileValue={( undefined !== btns[ index ].responsiveSize && undefined !== btns[ index ].responsiveSize[ 1 ] ? btns[ index ].responsiveSize[ 1 ] : '' )}
							onChangeMobile={( value ) => {
								saveArrayUpdate( { responsiveSize: [ ( undefined !== btns[ index ].responsiveSize && undefined !== btns[ index ].responsiveSize[ 0 ] ? btns[ index ].responsiveSize[ 0 ] : '' ), value ] }, index );
							}}
							min={0}
						...
						{'custom' === btns[ index ].btnSize && (
							<div className="bst-inner-sub-section">
								<h2 className="bst-heading-size-title bst-secondary-color-size">{__( 'Padding', 'gutenam-blocks' )}</h2>
											...
											if ( tab.name ) {
												if ( 'mobile' === tab.name ) {
													tabout = (
														<Fragment>
															<RangeControl
																label={__( 'Top and Bottom Padding', 'gutenam-blocks' )}
																...
																onChange={value => {
																	saveArrayUpdate( { responsivePaddingBT: [ ( undefined !== btns[ index ].responsivePaddingBT && undefined !== btns[ index ].responsivePaddingBT[ 0 ] ? btns[ index ].responsivePaddingBT[ 0 ] : '' ), value ] }, index );
																}}
																min={0}
																max={100}
															/>
															<RangeControl
																label={__( 'Left and Right Padding', 'gutenam-blocks' )}
																...
																onChange={value => {
																	saveArrayUpdate( { responsivePaddingLR: [ ( undefined !== btns[ index ].responsivePaddingLR && undefined !== btns[ index ].responsivePaddingLR[ 0 ] ? btns[ index ].responsivePaddingLR[ 0 ] : '' ), value ] }, index );
																}}
																min={0}
																max={100}
															/>
													...
													tabout = (
														<Fragment>
															<RangeControl
																...
																onChange={value => {
																	saveArrayUpdate( { responsivePaddingBT: [ value, ( undefined !== btns[ index ].responsivePaddingBT && undefined !== btns[ index ].responsivePaddingBT[ 1 ] ? btns[ index ].responsivePaddingBT[ 1 ] : '' ) ] }, index );
																}}
																min={0}
																max={100}
															/>
															<RangeControl
																...
																onChange={value => {
																	saveArrayUpdate( { responsivePaddingLR: [ value, ( undefined !== btns[ index ].responsivePaddingLR && undefined !== btns[ index ].responsivePaddingLR[ 1 ] ? btns[ index ].responsivePaddingLR[ 1 ] : '' ) ] }, index );
																}}
																min={0}
																max={100}
															/>
						...
						<div className="bst-btn-size-settings-container">
							<h2 className="bst-beside-btn-group">{__( 'Button Width', 'gutenam-blocks' )}</h2>
							<ButtonGroup className="bst-button-size-type-options" aria-label={__( 'Button Width', 'gutenam-blocks' )}>
						...
						{'full' === widthType && (
							<ToggleControl
								label={__( 'Collapse on mobile', 'gutenam-blocks' )}
						...
						{'fixed' === widthType && (
							<div className="bst-inner-sub-section">
								<ResponsiveRangeControls
									...
									onChange={value => {
										saveArrayUpdate( { width: [ value, ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 1 ] ? btns[ index ].width[ 1 ] : '' ), ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 2 ] ? btns[ index ].width[ 2 ] : '' ) ] }, index );
									}}
									tabletValue={( btns[ index ].width && undefined !== btns[ index ].width[ 1 ] ? btns[ index ].width[ 1 ] : undefined )}
									onChangeTablet={value => {
										saveArrayUpdate( { width: [ ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 0 ] ? btns[ index ].width[ 0 ] : '' ), value, ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 2 ] ? btns[ index ].width[ 2 ] : '' ) ] }, index );
									}}
									mobileValue={( btns[ index ].width && undefined !== btns[ index ].width[ 2 ] ? btns[ index ].width[ 2 ] : undefined )}
									onChangeMobile={value => {
										saveArrayUpdate( { width: [ ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 0 ] ? btns[ index ].width[ 0 ] : '' ), ( undefined !== btns[ index ].width && undefined !== btns[ index ].width[ 1 ] ? btns[ index ].width[ 1 ] : '' ), value ] }, index );
									}}
									min={10}
				...
				{showSettings( 'colorSettings', 'base/advancedbtn' ) && (
					<Fragment>
						<h2 className="bst-tab-wrap-title bst-color-settings-title" style={ { marginBottom: '10px'} }>{__( 'Color Settings', 'gutenam-blocks' )}</h2>
						...
						/>
						<SelectControl
							label={__( 'Border Style', 'gutenam-blocks' )}
							...
							options={[
								...
								{ value: 'double', label: __( 'Double', 'gutenam-blocks' ) },
								{ value: 'groove', label: __( 'Groove', 'gutenam-blocks' ) },
								{ value: 'ridge', label: __( 'Ridge', 'gutenam-blocks' ) },
							]}
							onChange={value => {
						...
						/>
						<ResponsiveMeasureRangeControl
							label={__( 'Button Margin', 'gutenam-blocks' )}
				...
				{showSettings( 'iconSettings', 'base/advancedbtn' ) && (
					<Fragment>
						<h2 className="bst-tool">{__( 'Icon Settings', 'gutenam-blocks' )}</h2>
						...
						<ResponsiveRangeControls
							...
							onChange={value => {
								saveArrayUpdate( { iconSize: [ value, ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 1 ] && btns[ index ].iconSize[ 1 ] ? btns[ index ].iconSize[ 1 ] : '' ), ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 2 ] && btns[ index ].iconSize[ 2 ] ? btns[ index ].iconSize[ 2 ] : '' ) ] }, index );
							}}
							tabletValue={( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 1 ] && btns[ index ].iconSize[ 1 ] ? btns[ index ].iconSize[ 1 ] : '' )}
							onChangeTablet={( value ) => {
								saveArrayUpdate( { iconSize: [ ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 0 ] && btns[ index ].iconSize[ 0 ] ? btns[ index ].iconSize[ 0 ] : '' ), value, ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 2 ] && btns[ index ].iconSize[ 2 ] ? btns[ index ].iconSize[ 2 ] : '' ) ] }, index );
							}}
							mobileValue={( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 2 ] && btns[ index ].iconSize[ 2 ] ? btns[ index ].iconSize[ 2 ] : '' )}
							onChangeMobile={( value ) => {
								saveArrayUpdate( { iconSize: [ ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 0 ] && btns[ index ].iconSize[ 0 ] ? btns[ index ].iconSize[ 0 ] : '' ), ( btns[ index ].iconSize && undefined !== btns[ index ].iconSize[ 1 ] && btns[ index ].iconSize[ 1 ] ? btns[ index ].iconSize[ 1 ] : '' ), value ] }, index );
							}}
							min={0}
						...
						<SmallResponsiveControl
							...
							desktopChildren={<ToggleControl
								...
								onChange={( value ) => saveArrayUpdate( { onlyIcon: [ value, ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 1 ] ? btns[ index ].onlyIcon[ 1 ] : '' ), ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 2 ] ? btns[ index ].onlyIcon[ 2 ] : '' ) ] }, index )}
							/>}
							tabletChildren={<ToggleControl
								...
								onChange={( value ) => saveArrayUpdate( { onlyIcon: [ ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 0 ] ? btns[ index ].onlyIcon[ 0 ] : false ), value, ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 2 ] ? btns[ index ].onlyIcon[ 2 ] : '' ) ] }, index )}
							/>}
							mobileChildren={<ToggleControl
								...
								onChange={( value ) => saveArrayUpdate( { onlyIcon: [ ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 0 ] ? btns[ index ].onlyIcon[ 0 ] : false ), ( undefined !== btns[ index ].onlyIcon && undefined !== btns[ index ].onlyIcon[ 1 ] ? btns[ index ].onlyIcon[ 1 ] : '' ), value ] }, index )}
							/>}
						/>
						<ResponsiveMeasurementControls
				...
				/>
				<h2 className="bst-heading-size-title bst-secondary-color-size">{__( 'Gap Between Next', 'gutenam-blocks' )}</h2>
				<TabPanel className="bst-size-tabs"
						  activeClass="active-tab"
						  tabs={[
							  {
	...
	const hoverSettings = ( index ) => {
		return (
			<div>
				<PopColorControl
					label={__( 'Hover Text Color', 'gutenam-blocks' )}
				...
				{'gradient' !== btns[ index ].backgroundHoverType && (
					<div className="bst-inner-sub-section">
						<PopColorControl
							...
							onArrayChange={( color, opacity ) => saveArrayUpdate( { backgroundHover: color, backgroundHoverOpacity: opacity }, index )}
						/>
					</div>
				)}
				{'gradient' === btns[ index ].backgroundHoverType && (
				...
				<PopColorControl
					...
					onArrayChange={( color, opacity ) => saveArrayUpdate( { borderHover: color, borderHoverOpacity: opacity }, index )}
				/>
				<BoxShadowControl
					label={__( 'Hover Box Shadow', 'gutenam-blocks' )}
					...
					onArrayChange={( color, opacity ) => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), color, opacity, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					...
					onEnableChange={value => {
						saveArrayUpdate( { boxShadowHover: [ value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onColorChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onOpacityChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onHOffsetChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onVOffsetChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onBlurChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onSpreadChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), value, ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 7 ] ? btns[ index ].boxShadowHover[ 7 ] : false ) ] }, index );
					}}
					onInsetChange={value => {
						saveArrayUpdate( { boxShadowHover: [ ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] ? btns[ index ].boxShadowHover[ 0 ] : false ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 0.4 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 2 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 3 ), ( btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ), value ] }, index );
					}}
				/>
			</div>
		);
		...
		return (
			<div>
				...
				{'gradient' !== btns[ index ].backgroundType && (
					<div className="bst-inner-sub-section">
						<PopColorControl
							...
							onArrayChange={( color, opacity ) => saveArrayUpdate( { background: color, backgroundOpacity: opacity }, index )}
						/>
					</div>
				)}
				{'gradient' === btns[ index ].backgroundType && (
					<div className="bst-inner-sub-section">
						...
						<RangeControl
							...
							onChange={( value ) => {
								saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), value, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
							}}
							min={0}
							max={100}
						/>
						<PopColorControl
							...
							onChange={value => {
								saveArrayUpdate( { gradient: [ value, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
							}}
							onOpacityChange={value => {
								saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), value, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
							}}
						/>
						<RangeControl
							label={__( 'Location', 'gutenam-blocks' )}
							...
							onChange={( value ) => {
								saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), value, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
							}}
							min={0}
							max={100}
						/>
							...
							<ButtonGroup className="bst-button-size-type-options" aria-label={__( 'Gradient Type', 'gutenam-blocks' )}>
								{map( gradTypes, ( { name, key } ) => (
									<Button
										...
										onClick={() => {
											saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), key, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
										}}
									>
										{name}
									</Button>
						...
						{'radial' !== ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ) && (
							<RangeControl
								...
								onChange={( value ) => {
									saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), value, ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 6 ] ? btns[ index ].gradient[ 6 ] : 'center center' ) ] }, index );
								}}
								min={0}
								max={360}
							/>
						...
						{'radial' === ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ) && (
							<SelectControl
								...
								onChange={value => {
									saveArrayUpdate( { gradient: [ ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 0 ] ? btns[ index ].gradient[ 0 ] : '#999999' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 1 ] ? btns[ index ].gradient[ 1 ] : 1 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 2 ] ? btns[ index ].gradient[ 2 ] : 0 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 3 ] ? btns[ index ].gradient[ 3 ] : 100 ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 4 ] ? btns[ index ].gradient[ 4 ] : 'linear' ), ( btns[ index ].gradient && undefined !== btns[ index ].gradient[ 5 ] ? btns[ index ].gradient[ 5 ] : 180 ), value ] }, index );
								}}
							/>
						)}
					</div>
				...
				<PopColorControl
					...
					onArrayChange={( color, opacity ) => saveArrayUpdate( { border: color, borderOpacity: opacity }, index )}
				/>
				<BoxShadowControl
	...
	const renderBtnCSS = ( index ) => {
		...
		if ( undefined !== btns[ index ].backgroundHoverType && 'gradient' === btns[ index ].backgroundHoverType && undefined !== btns[ index ].gradientHover ) {
			btnGrad = ( undefined === btns[ index ].backgroundHover ? BaseColorOutput( '#444444', ( btns[ index ].backgroundHoverOpacity !== undefined ? btns[ index ].backgroundHoverOpacity : 1 ) ) : BaseColorOutput( btns[ index ].backgroundHover, ( btns[ index ].backgroundHoverOpacity !== undefined ? btns[ index ].backgroundHoverOpacity : 1 ) ) );
			btnGrad2 = ( undefined === btns[ index ].gradientHover[ 0 ] ? BaseColorOutput( '#777777', ( btns[ index ].gradientHover[ 1 ] !== undefined ? btns[ index ].gradientHover[ 1 ] : 1 ) ) : BaseColorOutput( btns[ index ].gradientHover[ 0 ], ( btns[ index ].gradientHover[ 1 ] !== undefined ? btns[ index ].gradientHover[ 1 ] : 1 ) ) );
			...
			btnbg = BaseColorOutput( ( undefined === btns[ index ].backgroundHover ? '#444444' : btns[ index ].backgroundHover ), ( btns[ index ].backgroundHoverOpacity !== undefined ? btns[ index ].backgroundHoverOpacity : 1 ) );
		}
		if ( undefined !== btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] && btns[ index ].boxShadowHover[ 0 ] && false === btns[ index ].boxShadowHover[ 7 ] ) {
			btnBox = `${( undefined !== btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] && btns[ index ].boxShadowHover[ 0 ] ? ( undefined !== btns[ index ].boxShadowHover[ 7 ] && btns[ index ].boxShadowHover[ 7 ] ? 'inset ' : '' ) + ( undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 1 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 1 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 2 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ) + 'px ' + BaseColorOutput( ( undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 1 ) ) : undefined )}`;
			btnBox2 = 'none';
			btnRad = '0';
		}
		if ( undefined !== btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] && btns[ index ].boxShadowHover[ 0 ] && true === btns[ index ].boxShadowHover[ 7 ] ) {
			btnBox2 = `${( undefined !== btns[ index ].boxShadowHover && undefined !== btns[ index ].boxShadowHover[ 0 ] && btns[ index ].boxShadowHover[ 0 ] ? ( undefined !== btns[ index ].boxShadowHover[ 7 ] && btns[ index ].boxShadowHover[ 7 ] ? 'inset ' : '' ) + ( undefined !== btns[ index ].boxShadowHover[ 3 ] ? btns[ index ].boxShadowHover[ 3 ] : 1 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 4 ] ? btns[ index ].boxShadowHover[ 4 ] : 1 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 5 ] ? btns[ index ].boxShadowHover[ 5 ] : 2 ) + 'px ' + ( undefined !== btns[ index ].boxShadowHover[ 6 ] ? btns[ index ].boxShadowHover[ 6 ] : 0 ) + 'px ' + BaseColorOutput( ( undefined !== btns[ index ].boxShadowHover[ 1 ] ? btns[ index ].boxShadowHover[ 1 ] : '#000000' ), ( undefined !== btns[ index ].boxShadowHover[ 2 ] ? btns[ index ].boxShadowHover[ 2 ] : 1 ) ) : undefined )}`;
			btnRad = ( undefined !== btns[ index ].borderRadius ? btns[ index ].borderRadius : '3' );
			btnBox = 'none';
		}
		return (
			`#bst-btns_${uniqueID} .bst-button-${index}:hover {
					${( btns[ index ].colorHover ? 'color:' + BaseColorOutput( btns[ index ].colorHover ) + '!important;' : '' )}
					${( btns[ index ].borderHover || ( btns[ index ].borderHoverOpacity && 1 !== btns[ index ].borderHoverOpacity ) ? 'border-color:' + BaseColorOutput( ( undefined === btns[ index ].borderHover ? '#444444' : btns[ index ].borderHover ), ( btns[ index ].borderHoverOpacity !== undefined ? btns[ index ].borderHoverOpacity : 1 ) ) + '!important;' : '' )}
					${( btnBox ? 'box-shadow:' + btnBox + '!important;' : '' )}
				}
				${( btns[ index ].iconColorHover ? `#bst-btns_${uniqueID} .bst-button-${index}:hover .bst-btn-svg-icon { color:${BaseColorOutput( btns[ index ].iconColorHover )} !important;}` : '' )}
				#bst-btns_${uniqueID} .bst-button-${index}::before {
	...
	return (
		<div {...blockProps}>
			{renderCSS}
			<div id={`bst-btns_${uniqueID}`}
				 className={`${className} bst-btn-align-${hAlign}${thAlign ? ` bst-btn-tab-align-${thAlign}` : ''}${mhAlign ? ` bst-btn-mobile-align-${mhAlign}` : ''}${( forceFullwidth ? ' bst-force-btn-fullwidth' : '' )}`}>
				<BlockControls>
					<AlignmentToolbar
						value={hAlign}
				...
				{showSettings( 'allSettings', 'base/advancedbtn' ) && (
					<Fragment>
						<InspectorControls>
							...
							{( activeTab === 'general' ) &&
								<>
									{ showSettings( 'countSettings', 'base/advancedbtn' ) && (
										<BasePanelBody
											title={__( 'Button Count', 'gutenam-blocks' )}
											initialOpen={true}
											panelName={'bsb-adv-btn-count'}
										>
											{!lockBtnCount && (
												<PanelRow>
													<Button
													...
													>
														{__( 'Add Button', 'gutenam-blocks' )}
													</Button>
												</PanelRow>
											)}

											<ResponsiveAlignControls
												label={__( 'Button Alignment', 'gutenam-blocks' )}
												value={( hAlign ? hAlign : '' )}
							...
							{( activeTab === 'style' ) &&
								<>
									{ showSettings( 'fontSettings', 'base/advancedbtn' ) && (
										<BasePanelBody
											title={__( 'Font Family', 'gutenam-blocks' )}
											className="bst-font-family-area"
							...
							{( activeTab === 'advanced' ) && (
								<>
									...
									<BaseBlockDefaults attributes={attributes} defaultAttributes={metadata['attributes']} blockSlug={ 'base/advancedbtn' } excludedAttrs={ [ 'btnCount', 'lockBtnCount', 'hideLink' ] } preventMultiple={ [ 'btns' ] } />
								</>
							)}
						</InspectorControls>
						<InspectorAdvancedControls>
							<ToggleControl
								label={__( 'Force Button Fullwidth', 'gutenam-blocks' )}
				...
				<div id={`animate-id${uniqueID}`} className={'btn-inner-wrap aos-animate bst-animation-wrap'} data-aos={( baseAnimation ? baseAnimation : undefined )}
