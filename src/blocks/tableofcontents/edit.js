 ...
 * Build the TOC edit
 */
function BaseTableOfContents( { attributes, setAttributes, clientId, className, isSelected, pageIndex, postContent, blockOrder, isTyping } ) {
	const {
		uniqueID,
		allowedHeaders,
		columns,
	...
	useEffect( () => {
		...
		if ( ! uniqueID ) {
			attributes = setBlockDefaults( 'base/tableofcontents', attributes);
		...
		if ( ( '' !== containerBorder?.[0] || '' !== containerBorder?.[1] || '' !== containerBorder?.[2] || '' !== containerBorder?.[3] ) ) {
	...
	const columnOptions = [
		[
			{
				icon    : oneColumnIcon,
				title   : __( 'One Column', 'gutenam-blocks' ),
		...
		[
			{
				icon    : twoColumnIcon,
				title   : __( 'Two columns', 'gutenam-blocks' ),
		...
		[
			{
				...
				title   : __( 'Three Columns', 'gutenam-blocks' ),
	...
	const listOptions = [
		[
			{
				icon    : bulletsIcon,
				title   : __( 'Bullets', 'gutenam-blocks' ),
		...
		[
			{
				icon    : numberedIcon,
				title   : __( 'Numbered', 'gutenam-blocks' ),
	...
	const previewContentSize = getPreviewSize( previewDevice, ( undefined !== contentSize && undefined !== contentSize[0] ? contentSize[0] : '' ), ( undefined !== contentSize && undefined !== contentSize[1] ? contentSize[1] : '' ), ( undefined !== contentSize && undefined !== contentSize[2] ? contentSize[2] : '' ) );
	const previewContentHeight = getPreviewSize( previewDevice, ( undefined !== contentLineHeight && undefined !== contentLineHeight[0] ? contentLineHeight[0] : '' ), ( undefined !== contentLineHeight && undefined !== contentLineHeight[1] ? contentLineHeight[1] : '' ), ( undefined !== contentLineHeight && undefined !== contentLineHeight[2] ? contentLineHeight[2] : '' ) );

	const previewTitleSize = getPreviewSize( previewDevice, ( undefined !== titleSize?.[0] ? titleSize[0] : '' ), ( undefined !== titleSize?.[1] ? titleSize[1] : '' ), ( undefined !== titleSize?.[2] ? titleSize[2] : '' ) );
	const previewTitleHeight = getPreviewSize( previewDevice, ( undefined !== titleLineHeight?.[0] ? titleLineHeight[0] : '' ), ( undefined !== titleLineHeight?.[1] ? titleLineHeight[1] : '' ), ( undefined !== titleLineHeight?.[2] ? titleLineHeight[2] : '' ) );

	const previewListGap = getPreviewSize( previewDevice, ( undefined !== listGap?.[0] ? listGap[0] : '' ), ( undefined !== listGap?.[1] ? listGap[1] : '' ), ( undefined !== listGap?.[2] ? listGap[2] : '' ) );

	const previewMaxWidth = getPreviewSize( previewDevice, ( undefined !== maxWidth ? maxWidth : '' ), ( undefined !== tabletMaxWidth ? tabletMaxWidth : '' ), ( undefined !== mobileMaxWidth ? mobileMaxWidth : '' ) );

	const previewMarginTop = getPreviewSize( previewDevice, ( undefined !== containerMargin?.[0] ? containerMargin[0] : '' ), ( undefined !== containerTabletMargin?.[0] ? containerTabletMargin[0] : '' ), ( undefined !== containerMobileMargin?.[0] ? containerMobileMargin[0] : '' ) );
	const previewMarginRight = getPreviewSize( previewDevice, ( undefined !== containerMargin?.[1] ? containerMargin[1] : '' ), ( undefined !== containerTabletMargin?.[1] ? containerTabletMargin[1] : '' ), ( undefined !== containerMobileMargin?.[1] ? containerMobileMargin[1] : '' ) );
	const previewMarginBottom = getPreviewSize( previewDevice, ( undefined !== containerMargin?.[2] ? containerMargin[2] : '' ), ( undefined !== containerTabletMargin?.[2] ? containerTabletMargin[2] : '' ), ( undefined !== containerMobileMargin?.[2] ? containerMobileMargin[2] : '' ) );
	const previewMarginLeft = getPreviewSize( previewDevice, ( undefined !== containerMargin?.[3] ? containerMargin[3] : '' ), ( undefined !== containerTabletMargin?.[3] ? containerTabletMargin[3] : '' ), ( undefined !== containerMobileMargin?.[3] ? containerMobileMargin[3] : '' ) );
	const previewMarginUnit = ( containerMarginUnit ? containerMarginUnit : 'px' );
	const previewPaddingTop = getPreviewSize( previewDevice, ( undefined !== containerPadding?.[0] ? containerPadding[0] : '' ), ( undefined !== tabletContainerPadding?.[0] ? tabletContainerPadding[0] : '' ), ( undefined !== mobileContainerPadding?.[0] ? mobileContainerPadding[0] : '' ) );
	const previewPaddingRight = getPreviewSize( previewDevice, ( undefined !== containerPadding?.[1] ? containerPadding[1] : '' ), ( undefined !== tabletContainerPadding?.[1] ? tabletContainerPadding[1] : '' ), ( undefined !== mobileContainerPadding?.[1] ? mobileContainerPadding[1] : '' ) );
	const previewPaddingBottom = getPreviewSize( previewDevice, ( undefined !== containerPadding?.[2] ? containerPadding[2] : '' ), ( undefined !== tabletContainerPadding?.[2] ? tabletContainerPadding[2] : '' ), ( undefined !== mobileContainerPadding?.[2] ? mobileContainerPadding[2] : '' ) );
	const previewPaddingLeft = getPreviewSize( previewDevice, ( undefined !== containerPadding?.[3] ? containerPadding[3] : '' ), ( undefined !== tabletContainerPadding?.[3] ? tabletContainerPadding[3] : '' ), ( undefined !== mobileContainerPadding?.[3] ? mobileContainerPadding[3] : '' ) );
	...
	const previewTitlePaddingTop = getPreviewSize( previewDevice, ( undefined !== titlePadding && undefined !== titlePadding[0] ? titlePadding[0] : '' ), ( undefined !== tabletTitlePadding && undefined !== tabletTitlePadding[0] ? tabletTitlePadding[0] : '' ), ( undefined !== mobileTitlePadding && undefined !== mobileTitlePadding[0] ? mobileTitlePadding[0] : '' ) );
	const previewTitlePaddingRight = getPreviewSize( previewDevice, ( undefined !== titlePadding && undefined !== titlePadding[1] ? titlePadding[1] : '' ), ( undefined !== tabletTitlePadding && undefined !== tabletTitlePadding[1] ? tabletTitlePadding[1] : '' ), ( undefined !== mobileTitlePadding && undefined !== mobileTitlePadding[1] ? mobileTitlePadding[1] : '' ) );
	const previewTitlePaddingBottom = getPreviewSize( previewDevice, ( undefined !== titlePadding && undefined !== titlePadding[2] ? titlePadding[2] : '' ), ( undefined !== tabletTitlePadding && undefined !== tabletTitlePadding[2] ? tabletTitlePadding[2] : '' ), ( undefined !== mobileTitlePadding && undefined !== mobileTitlePadding[2] ? mobileTitlePadding[2] : '' ) );
	const previewTitlePaddingLeft = getPreviewSize( previewDevice, ( undefined !== titlePadding && undefined !== titlePadding[3] ? titlePadding[3] : '' ), ( undefined !== tabletTitlePadding && undefined !== tabletTitlePadding[3] ? tabletTitlePadding[3] : '' ), ( undefined !== mobileTitlePadding && undefined !== mobileTitlePadding[3] ? mobileTitlePadding[3] : '' ) );

	const previewContentMarginTop = getPreviewSize( previewDevice, ( undefined !== contentMargin?.[0] ? contentMargin[0] : '' ), ( undefined !== tabletContentMargin?.[0] ? tabletContentMargin[0] : '' ), ( undefined !== mobileContentMargin?.[0] ? mobileContentMargin[0] : '' ) );
	const previewContentMarginRight = getPreviewSize( previewDevice, ( undefined !== contentMargin?.[1] ? contentMargin[1] : '' ), ( undefined !== tabletContentMargin?.[1] ? tabletContentMargin[1] : '' ), ( undefined !== mobileContentMargin?.[1] ? mobileContentMargin[1] : '' ) );
	const previewContentMarginBottom = getPreviewSize( previewDevice, ( undefined !== contentMargin?.[2] ? contentMargin[2] : '' ), ( undefined !== tabletContentMargin?.[2] ? tabletContentMargin[2] : '' ), ( undefined !== mobileContentMargin?.[2] ? mobileContentMargin[2] : '' ) );
	const previewContentMarginLeft = getPreviewSize( previewDevice, ( undefined !== contentMargin?.[3] ? contentMargin[3] : '' ), ( undefined !== tabletContentMargin?.[3] ? tabletContentMargin[3] : '' ), ( undefined !== mobileContentMargin?.[3] ? mobileContentMargin[3] : '' ) );
	...
	const previewTitleBorderTopStyle = getBorderStyle( previewDevice, 'top', titleBorderStyle, tabletTitleBorderStyle, mobileTitleBorderStyle );
	const previewTitleBorderRightStyle = getBorderStyle( previewDevice, 'right', titleBorderStyle, tabletTitleBorderStyle, mobileTitleBorderStyle );
	const previewTitleBorderBottomStyle = getBorderStyle( previewDevice, 'bottom', titleBorderStyle, tabletTitleBorderStyle, mobileTitleBorderStyle );
	const previewTitleBorderLeftStyle = getBorderStyle( previewDevice, 'left', titleBorderStyle, tabletTitleBorderStyle, mobileTitleBorderStyle );

	const classes = classnames( className, `bsb-table-of-content-nav bsb-table-of-content-id${uniqueID}` );
	const blockProps = useBlockProps( {
		className: classes,
	} );
	const renderCSS = (
		<style>
			{`.bsb-table-of-content-id${uniqueID} .bsb-table-of-content-list li {
					margin-bottom: ${( previewListGap ? previewListGap + 'px' : 'auto' )};
				}
				.bsb-table-of-content-id${uniqueID} .bsb-table-of-content-list li .bsb-table-of-contents-list-sub {
					margin-top: ${( previewListGap ? previewListGap + 'px' : 'auto' )};
				}
				.bsb-table-of-content-id${uniqueID} .bsb-table-of-contents__entry:hover {
					color: ${BaseColorOutput( contentHoverColor )} !important;
				}
				.bsb-table-of-content-id${uniqueID} .bsb-table-of-contents-title-wrap.bsb-toc-toggle-hidden {
					border-color: ${BaseColorOutput( titleCollapseBorderColor )} !important;
				}
				.bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-basiccircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-basiccircle .bsb-table-of-contents-icon-trigger:before, .bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-arrowcircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-arrowcircle .bsb-table-of-contents-icon-trigger:before, .bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-xclosecircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-id${uniqueID} .bsb-toggle-icon-style-xclosecircle .bsb-table-of-contents-icon-trigger:before {
					background-color: ${BaseColorOutput( containerBackground )} !important;
				}`}
		</style>
	);
	const blockControls = (
		<BlockControls>
			<ToolbarGroup>
				<ToolbarDropdownMenu
					...
					label={__( 'Select List Columns', 'gutenam-blocks' )}
			...
			<ToolbarGroup>
				<ToolbarDropdownMenu
					...
					label={__( 'Select List Style', 'gutenam-blocks' )}
	...
	const inspectorControls = (
		<>
				<BaseInspectorControls blockSlug={ 'base/tableofcontents'}>
					...
					{(activeTab === 'general') &&
						<>
							...
							<BasePanelBody
								title={__('Allowed Headers', 'gutenam-blocks')}
								initialOpen={true}
								panelName={'allowedHeaders'}
								blockSlug={'base/tableofcontents'}
							>
								<ToggleControl
									label={'h1'}
							...
							<Fragment>
								{enableTitle && (
									<BasePanelBody
										title={__('Collapsible Settings', 'gutenam-blocks')}
										initialOpen={false}
										panelName={'collapsibleSettings'}
										blockSlug={'base/tableofcontents'}
									>
										<ToggleControl
											label={__('Enable Collapsible Content', 'gutenam-blocks')}
										...
										{enableTitle && (
											<Fragment>
												<ToggleControl
													label={__('Start Collapsed', 'gutenam-blocks')}
													checked={startClosed}
												...
												/>
												<ToggleControl
													label={__('Enable title to toggle as well as icon', 'gutenam-blocks')}
					...
					{(activeTab === 'advanced') &&
						<>
							<BasePanelBody panelName={'bsb-toc-spacing-settings'}>
								<ResponsiveMeasureRangeControl
							...
							<BasePanelBody
								title={__('Non static content', 'gutenam-blocks')}
								panelName={'nonStaticContent'}
								initialOpen={false}
								blockSlug={'base/tableofcontents'}
							>
								<ToggleControl
									label={__('Search for Headings in Non static post content?', 'gutenam-blocks')}
									checked={enableDynamicSearch}
									onChange={value => setAttributes({enableDynamicSearch: value})}
								/>
								{ isBaseT && enableDynamicSearch && (
									<ToggleControl
										label={__('Search for Headings in Template?', 'gutenam-blocks')}
										help={__('Expands heading search to use dynamic template from elements.', 'gutenam-blocks')}
							...
							<BasePanelBody
								title={__('Scroll Settings', 'gutenam-blocks')}
								initialOpen={false}
								panelName={'scrollSettings'}
								blockSlug={'base/tableofcontents'}
							>
								<ToggleControl
									label={__('Enable Smooth Scroll to ID', 'gutenam-blocks')}
									checked={enableSmoothScroll}
									onChange={value => setAttributes({enableSmoothScroll: value})}
								/>
								{enableSmoothScroll && (
									<RangeControl
										label={__('Scroll Offset', 'gutenam-blocks')}
								...
								<ToggleControl
									label={__('Enable Highlighting Heading when scrolling in active area.', 'gutenam-blocks')}
									checked={enableScrollSpy}
									onChange={value => setAttributes({enableScrollSpy: value})}
								/>
								{enableScrollSpy && (
									<PopColorControl
										label={__('List Items Active Color', 'gutenam-blocks')}
					...
					{(activeTab === 'style') && (
						<>
							...
							>
								<ToggleControl
									label={__('Enable Title', 'gutenam-blocks')}
									checked={enableTitle}
							...
							<BasePanelBody
								title={__('List Settings', 'gutenam-blocks')}
								initialOpen={false}
								panelName={'listSettings'}
								blockSlug={'base/tableofcontents'}
							>
								<ResponsiveRangeControls
									label={__('List Item Gap', 'gutenam-blocks')}
									value={ listGap?.[0] ? listGap[0] : ''}
									mobileValue={ listGap?.[2] ? listGap[2] : ''}
									tabletValue={ listGap?.[1] ? listGap[1] : ''}
									onChange={(value) => setAttributes({listGap: [value, ( listGap?.[1] ? listGap[1] : ''), ( listGap?.[2] ? listGap[2] : '')]})}
									onChangeTablet={(value) => setAttributes({listGap: [( listGap?.[0] ? listGap[0] : ''), value, ( listGap?.[2] ? listGap[2] : '')]})}
									onChangeMobile={(value) => setAttributes({listGap: [( listGap?.[0] ? listGap[0] : ''), ( listGap?.[1] ? listGap[1] : ''), value]})}
									min={0}
									max={60}
									step={1}
									unit={'px'}
								...
								/>
								<PopColorControl
									label={__('List Items Color', 'gutenam-blocks')}
									swatchLabel={__('Normal Color', 'gutenam-blocks')}
								...
								/>
								<SelectControl
									label={__('List Link Style', 'gutenam-blocks')}
									value={linkStyle}
									options={[
	...
	// 			{ inspectorControls }
	// 			<Placeholder
	// 				className="bsb-table-of-content-wrap"
	// 				icon={ icons.block }
	// 				label={ __( 'Table of Contents', 'gutenam-blocks' ) }
	// 				instructions={ __( 'Start adding Heading blocks to create a table of contents.', 'gutenam-blocks' ) }
	// 			/>
	// 		</div>
	// 	);
	// }
	return (
		<>
			...
			{inspectorControls}
			<nav {...blockProps}>
				<div className="bsb-table-of-content-wrap" style={{
					...
					backgroundColor: BaseColorOutput( containerBackground ),
					...
					{enableTitle && (
						<div
							className={`bsb-table-of-contents-title-wrap bsb-toggle-icon-style-${( enableToggle && toggleIcon ? toggleIcon : 'none' )} bsb-toc-toggle-${( showContent ? 'active' : 'hidden' )}`}
							style={{
								...
								color      : titleColor ? BaseColorOutput( titleColor ) : undefined,
						...
						>
							<SpacingVisualizer
								...
								spacing={ [ getSpacingOptionOutput( previewTitlePaddingTop, titlePaddingType ), getSpacingOptionOutput( previewTitlePaddingRight, titlePaddingType ), getSpacingOptionOutput( previewTitlePaddingBottom, titlePaddingType ), getSpacingOptionOutput( previewTitlePaddingLeft, titlePaddingType ) ] }
							/>
							{ titleGoogleFont && titleTypography && (
								<BaseWebfontLoader typography={ [{family: titleTypography, variant: ( titleFontVariant ? titleFontVariant : '' ) }] } clientId={ clientId } id={ 'titleTOC' } />
							) }
							<RichText
								tagName="div"
								placeholder={__( 'Optional Title', 'gutenam-blocks' )}
								format="string"
								value={title}
								onChange={value => {
								...
								className={'bsb-table-of-contents-title'}
								style={{
									color        : 'inherit',
									fontWeight   : titleFontWeight,
									fontStyle    : titleFontStyle,
									fontSize     : ( previewTitleSize ? getFontSizeOptionOutput( previewTitleSize, titleSizeType ) : undefined ),
							...
							{enableToggle && (
								<div
									className="bsb-table-of-contents-icon-trigger"
									onClick={() => onToggle()}
									role="button"
									tabIndex="0"
									onKeyDown={( event ) => {
					...
					{headings.length === 0 && (
						<div className="bsb-table-of-content-placeholder">
							<p>{__( 'Start adding Heading blocks to create a table of contents.', 'gutenam-blocks' )}</p>
						</div>
					)}
					{( ( enableToggle && showContent ) || !enableToggle ) && (
						<ListTag
							className={`bsb-table-of-content-list bsb-table-of-content-list-columns-${columns} bsb-table-of-content-list-style-${listStyle} bsb-table-of-content-link-style-${linkStyle}`}
							style={{
								color        : contentColor ? BaseColorOutput( contentColor ) : undefined,
								fontWeight   : contentFontWeight,
								fontStyle    : contentFontStyle,
								fontSize     : ( previewContentSize ? getFontSizeOptionOutput( previewContentSize, contentSizeType ) : undefined ),
								...
								marginTop	   : ( previewContentMarginTop ? getSpacingOptionOutput( previewContentMarginTop, contentMarginType ) : undefined ),
								marginRight   : ( previewContentMarginRight ? getSpacingOptionOutput( previewContentMarginRight, contentMarginType ) : undefined ),
								marginBottom  : ( previewContentMarginBottom ? getSpacingOptionOutput( previewContentMarginBottom, contentMarginType ) : undefined ),
								marginLeft	   : ( previewContentMarginLeft ? getSpacingOptionOutput( previewContentMarginLeft, contentMarginType ) : undefined ),
							}}
						>
							<SpacingVisualizer
								type="outside"
								forceShow={ contentMouseOver.isMouseOver }
								spacing={ [ getSpacingOptionOutput( previewContentMarginTop, contentMarginType ), getSpacingOptionOutput( previewContentMarginRight, contentMarginType ), getSpacingOptionOutput( previewContentMarginBottom, contentMarginType ), getSpacingOptionOutput( previewContentMarginLeft, contentMarginType ) ] }
							/>
							{ contentGoogleFont && contentTypography && (
								<BaseWebfontLoader typography={ [{family: contentTypography, variant: ( contentFontVariant ? contentFontVariant : '' ) }] } clientId={ clientId } id={ 'contentTOC' } />
							) }
							{headings.length !== 0 && (
								<TableOfContentsList
				...
				<SpacingVisualizer
					...
					spacing={ [ getSpacingOptionOutput( previewPaddingTop, containerPaddingUnit ), getSpacingOptionOutput( previewPaddingRight, containerPaddingUnit ), getSpacingOptionOutput( previewPaddingBottom, containerPaddingUnit ), getSpacingOptionOutput( previewPaddingLeft, containerPaddingUnit ) ] }
				/>
				<SpacingVisualizer
