...
function BaseCounterUp( props ) {
	...
	useEffect( () => {
		setBlockDefaults( 'base/countup', attributes);
	...
	return (
		<div {...blockProps}>
			...
			<div className={classes}>
				<div
					className={'bsb-count-up-number'}
					style={{
						fontWeight   : numberFont[ 0 ].weight,
						fontStyle    : numberFont[ 0 ].style,
						color        : BaseColorOutput( numberColor ),
				...
				{displayTitle &&
					<TitleTagName className={'bsb-count-up-wrap'}
						style={{
							position:'relative',
						...
						<RichText
							...
							placeholder={__( 'Type Here...', 'gutenam-blocks' )}
							style={{
								display: 'block',
