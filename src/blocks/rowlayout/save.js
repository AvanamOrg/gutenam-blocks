 ...
 */
 function RowLayoutSave( {
	...
	const renderSlider = () => {
		...
		return (
			<div className={ `bst-blocks-carousel bst-carousel-container-dotstyle-${ bgSliderSettings[ 0 ].dotStyle } bst-carousel-container-arrowstyle-${bgSliderSettings[ 0 ].arrowStyle} bsb-blocks-bg-slider ` }>
				<div className={ `bst-blocks-carousel-init bsb-blocks-bg-slider-init bst-carousel-arrowstyle-${ bgSliderSettings[ 0 ].arrowStyle } bst-carousel-dotstyle-${ bgSliderSettings[ 0 ].dotStyle }` }
