...
import { hexToRGBA, BaseColorOutput, DeprecatedBaseColorOutput } from '@base/helpers';
...
const v5 = {
	...
	save: ( { attributes } ) => {
		const { uniqueID, testimonials, style, hAlign, layout, displayMedia, columnGap, autoPlay, autoSpeed, transSpeed, slidesScroll, arrowStyle, dotStyle, columns, displayIcon, iconStyles, containerVAlign, containerPaddingType } = attributes;
...
const v4 = {
	...
	save: ( { attributes } ) => {
		const { uniqueID, testimonials, style, hAlign, layout, itemsCount, containerBackground, containerBorder, containerBorderWidth, containerBorderRadius, containerPadding, mediaStyles, displayTitle, titleFont, displayContent, displayName, displayMedia, displayShadow, shadow, displayRating, ratingStyles, displayOccupation, containerBackgroundOpacity, containerBorderOpacity, containerMaxWidth, columnGap, autoPlay, autoSpeed, transSpeed, slidesScroll, arrowStyle, dotStyle, columns, displayIcon, iconStyles, containerVAlign, containerPaddingType } = attributes;
		const containerPaddingUnit = ( containerPaddingType ? containerPaddingType : 'px' );
		const containerStyles = {
			boxShadow        : ( displayShadow ? shadow[ 0 ].hOffset + 'px ' + shadow[ 0 ].vOffset + 'px ' + shadow[ 0 ].blur + 'px ' + shadow[ 0 ].spread + 'px ' + BaseColorOutput( ( undefined !== shadow[ 0 ].color && '' !== shadow[ 0 ].color ? shadow[ 0 ].color : '#000000' ), ( shadow[ 0 ].opacity ? shadow[ 0 ].opacity : 0.2 ) ) : undefined ),
			borderColor      : ( containerBorder ? BaseColorOutput( containerBorder, ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) : BaseColorOutput( '#eeeeee', ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) ),
			background       : ( containerBackground ? BaseColorOutput( containerBackground, ( undefined !== containerBackgroundOpacity ? containerBackgroundOpacity : 1 ) ) : undefined ),
		...
		const renderTestimonialIcon = ( index ) => {
			return (
				<div className="bst-svg-testimonial-global-icon-wrap" style={{
					...
					<IconRender className={`bst-svg-testimonial-global-icon bst-svg-testimonial-global-icon-${iconStyles[ 0 ].icon}`} name={iconStyles[ 0 ].icon} size={iconStyles[ 0 ].size}
								title={( iconStyles[ 0 ].title ? iconStyles[ 0 ].title : '' )} strokeWidth={( 'fe' === iconStyles[ 0 ].icon.substring( 0, 2 ) ? iconStyles[ 0 ].stroke : undefined )}
								style={{
									...
									borderColor      : ( iconStyles[ 0 ].border ? BaseColorOutput( iconStyles[ 0 ].border, ( undefined !== iconStyles[ 0 ].borderOpacity ? iconStyles[ 0 ].borderOpacity : 1 ) ) : undefined ),
		...
		const renderTestimonialMedia = ( index ) => {
			...
			return (
				<div className="bst-testimonial-media-wrap">
					<div className="bst-testimonial-media-inner-wrap" style={{
						width          : 'card' !== style ? mediaStyles[ 0 ].width + 'px' : undefined,
						borderColor    : BaseColorOutput( mediaStyles[ 0 ].border ),
						backgroundColor: ( mediaStyles[ 0 ].background ? BaseColorOutput( mediaStyles[ 0 ].background, ( undefined !== mediaStyles[ 0 ].backgroundOpacity ? mediaStyles[ 0 ].backgroundOpacity : 1 ) ) : undefined ),
						...
						<div className={'base-testimonial-image-intrisic'} style={{
							...
							{'icon' === testimonials[ index ].media && testimonials[ index ].icon && (
								<IconRender className={`bst-svg-testimonial-icon bst-svg-testimonial-icon-${testimonials[ index ].icon}`} name={testimonials[ index ].icon} size={testimonials[ index ].isize}
									...
									display: 'flex',
									color  : ( testimonials[ index ].color ? BaseColorOutput( testimonials[ index ].color ) : undefined ),
								}}/>
							)}
							{'icon' !== testimonials[ index ].media && testimonials[ index ].url && (
								<div className={'bst-testimonial-image'} style={{
		...
		const renderTestimonialPreview = ( index ) => {
			return (
				<div className={`bst-testimonial-item-wrap bst-testimonial-item-${index}${( containerVAlign ? ' testimonial-valign-' + containerVAlign : '' )}`}
					...
					<div className="bst-testimonial-text-wrap" style={( 'bubble' === style || 'inlineimage' === style ? containerStyles : undefined )}>
						...
						{displayRating && (
							<div className={`bst-testimonial-rating-wrap bst-testimonial-rating-${testimonials[ index ].rating}`} style={{
								...
								<IconRender className={'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-1'} name={'fas_star'} size={ratingStyles[ 0 ].size}
											style={{ color: BaseColorOutput( ratingStyles[ 0 ].color ) }}/>
								{testimonials[ index ].rating > 1 && (
									<IconRender className={'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-2'} name={'fas_star'} size={ratingStyles[ 0 ].size}
												style={{ color: BaseColorOutput( ratingStyles[ 0 ].color ) }}/>
								)}
								{testimonials[ index ].rating > 2 && (
									<IconRender className={'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-3'} name={'fas_star'} size={ratingStyles[ 0 ].size}
												style={{ color: BaseColorOutput( ratingStyles[ 0 ].color ) }}/>
								)}
								{testimonials[ index ].rating > 3 && (
									<IconRender className={'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-4'} name={'fas_star'} size={ratingStyles[ 0 ].size}
												style={{ color: BaseColorOutput( ratingStyles[ 0 ].color ) }}/>
								)}
								{testimonials[ index ].rating > 4 && (
									<IconRender className={'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-5'} name={'fas_star'} size={ratingStyles[ 0 ].size}
												style={{ color: BaseColorOutput( ratingStyles[ 0 ].color ) }}/>
								)}
							</div>
						)}
				...
				{layout && layout === 'carousel' && (
					<div className={`bst-blocks-carousel bst-carousel-container-dotstyle-${dotStyle} bst-carousel-container-arrowstyle-${arrowStyle}`}>
						<div className={`bst-blocks-carousel-init bst-carousel-arrowstyle-${arrowStyle} bst-carousel-dotstyle-${dotStyle}`} data-columns-xxl={columns[ 0 ]} data-columns-xl={columns[ 1 ]}
								...
								data-slider-hover-pause="false" data-slider-auto={autoPlay} data-slider-speed={autoSpeed}>
							{times( itemsCount, n =>
								<div className="bst-blocks-testimonial-carousel-item bsb-slide-item" key={n}>
...
const v3 = {
	...
	save: ( { attributes } ) => {
		...
		const renderTestimonialIcon = ( index ) => {
			return (
				<div className="bst-svg-testimonial-global-icon-wrap" style={ {
					...
					<IconRender className={ `bst-svg-testimonial-global-icon bst-svg-testimonial-global-icon-${ iconStyles[ 0 ].icon }` } name={ iconStyles[ 0 ].icon } size={ iconStyles[ 0 ].size } title={ ( iconStyles[ 0 ].title ? iconStyles[ 0 ].title : '' ) } strokeWidth={ ( 'fe' === iconStyles[ 0 ].icon.substring( 0, 2 ) ? iconStyles[ 0 ].stroke : undefined ) } style={ {
						color: ( iconStyles[ 0 ].color ? BaseColorOutput( iconStyles[ 0 ].color ) : undefined ),
						borderRadius: ( undefined !== iconStyles[ 0 ].borderRadius ? iconStyles[ 0 ].borderRadius + 'px' : undefined ),
						borderTopWidth: ( iconStyles[ 0 ].borderWidth && undefined !== iconStyles[ 0 ].borderWidth[ 0 ] && null !== iconStyles[ 0 ].borderWidth[ 0 ] ? iconStyles[ 0 ].borderWidth[ 0 ] + 'px' : undefined ),
						borderRightWidth: ( iconStyles[ 0 ].borderWidth && undefined !== iconStyles[ 0 ].borderWidth[ 1 ] && null !== iconStyles[ 0 ].borderWidth[ 1 ] ? iconStyles[ 0 ].borderWidth[ 1 ] + 'px' : undefined ),
				...
				<div className="bst-testimonial-media-wrap">
					<div className="bst-testimonial-media-inner-wrap" style={ {
						...
						<div className={ 'base-testimonial-image-intrisic' } style={ {
							...
							{ 'icon' === testimonials[ index ].media && testimonials[ index ].icon && (
								<IconRender className={ `bst-svg-testimonial-icon bst-svg-testimonial-icon-${ testimonials[ index ].icon }` } name={ testimonials[ index ].icon } size={ testimonials[ index ].isize } title={ ( testimonials[ index ].ititle ? testimonials[ index ].ititle : '' ) } strokeWidth={ ( 'fe' === testimonials[ index ].icon.substring( 0, 2 ) ? testimonials[ index ].istroke : undefined ) } style={ {
									display: 'flex',
									color: ( testimonials[ index ].color ? BaseColorOutput( testimonials[ index ].color ) : undefined ),
								} } />
							) }
		...
		const renderTestimonialPreview = ( index ) => {
			return (
				<div className={ `bst-testimonial-item-wrap bst-testimonial-item-${ index }${ ( containerVAlign ? ' testimonial-valign-' + containerVAlign : '' ) }` } style={ ( 'bubble' !== style && 'inlineimage' !== style ? containerStyles : {
					maxWidth: containerMaxWidth + 'px',
					paddingTop: ( displayIcon && iconStyles[ 0 ].icon && iconStyles[ 0 ].margin && iconStyles[ 0 ].margin[ 0 ] && ( iconStyles[ 0 ].margin[ 0 ] < 0 ) ? Math.abs( iconStyles[ 0 ].margin[ 0 ] ) + 'px' : undefined ),
				} ) }>
					<div className="bst-testimonial-text-wrap" style={ ( 'bubble' === style || 'inlineimage' === style ? containerStyles : undefined ) }>
						...
						{ displayRating && (
							<div className={ `bst-testimonial-rating-wrap bst-testimonial-rating-${ testimonials[ index ].rating }` } style={ {
								...
								<IconRender className={ 'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-1' } name={ 'fas_star' } size={ ratingStyles[ 0 ].size } style={ { color: BaseColorOutput( ratingStyles[ 0 ].color ) } } />
								{ testimonials[ index ].rating > 1 && (
									<IconRender className={ 'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-2' } name={ 'fas_star' } size={ ratingStyles[ 0 ].size } style={ { color: BaseColorOutput( ratingStyles[ 0 ].color ) } } />
								) }
								{ testimonials[ index ].rating > 2 && (
									<IconRender className={ 'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-3' } name={ 'fas_star' } size={ ratingStyles[ 0 ].size } style={ { color: BaseColorOutput( ratingStyles[ 0 ].color ) } } />
								) }
								{ testimonials[ index ].rating > 3 && (
									<IconRender className={ 'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-4' } name={ 'fas_star' } size={ ratingStyles[ 0 ].size } style={ { color: BaseColorOutput( ratingStyles[ 0 ].color ) } } />
								) }
								{ testimonials[ index ].rating > 4 && (
									<IconRender className={ 'bst-svg-testimonial-rating-icon bst-svg-testimonial-rating-icon-5' } name={ 'fas_star' } size={ ratingStyles[ 0 ].size } style={ { color: BaseColorOutput( ratingStyles[ 0 ].color ) } } />
								) }
							</div>
						) }
						{ displayContent && (
...
const v1 = {
	...
	save: ( { attributes } ) => {
		...
		const containerStyles = {
			boxShadow: ( displayShadow ? shadow[ 0 ].hOffset + 'px ' + shadow[ 0 ].vOffset + 'px ' + shadow[ 0 ].blur + 'px ' + shadow[ 0 ].spread + 'px ' + BaseColorOutput( ( undefined !== shadow[ 0 ].color && '' !== shadow[ 0 ].color ? shadow[ 0 ].color : '#000000' ), ( shadow[ 0 ].opacity ? shadow[ 0 ].opacity : 0.2 ) ) : undefined ),
			borderColor: ( containerBorder ? BaseColorOutput( containerBorder, ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) : hexToRGBA( '#eeeeee', ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) ),
			background: ( containerBackground ? BaseColorOutput( containerBackground, ( undefined !== containerBackgroundOpacity ? containerBackgroundOpacity : 1 ) ) : undefined ),
			borderRadius: ( undefined !== containerBorderRadius && '' !== containerBorderRadius && ! isNaN( containerBorderRadius ) ? containerBorderRadius + 'px' : undefined ),
			borderTopWidth: ( containerBorderWidth && undefined !== containerBorderWidth[ 0 ] && '' !== containerBorderWidth[ 0 ] ? containerBorderWidth[ 0 ] + 'px' : undefined ),
			borderRightWidth: ( containerBorderWidth && undefined !== containerBorderWidth[ 1 ] && '' !== containerBorderWidth[ 1 ] ? containerBorderWidth[ 1 ] + 'px' : undefined ),
...
const v_1 = {
	...
	save: ( { attributes } ) => {
		...
		const containerStyles = {
			boxShadow: ( displayShadow ? shadow[ 0 ].hOffset + 'px ' + shadow[ 0 ].vOffset + 'px ' + shadow[ 0 ].blur + 'px ' + shadow[ 0 ].spread + 'px ' + BaseColorOutput( ( undefined !== shadow[ 0 ].color && '' !== shadow[ 0 ].color ? shadow[ 0 ].color : '#000000' ), ( shadow[ 0 ].opacity ? shadow[ 0 ].opacity : 0.2 ) ) : undefined ),
			borderColor: ( containerBorder ? DeprecatedBaseColorOutput( containerBorder, ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) : hexToRGBA( '#eeeeee', ( undefined !== containerBorderOpacity ? containerBorderOpacity : 1 ) ) ),
			background: ( containerBackground ? BaseColorOutput( containerBackground, ( undefined !== containerBackgroundOpacity ? containerBackgroundOpacity : 1 ) ) : undefined ),
		...
		const renderTestimonialPreview = ( index ) => {
			return (
				<div className={ `bst-testimonial-item-wrap bst-testimonial-item-${ index }` } style={ ( 'bubble' !== style && 'inlineimage' !== style ? containerStyles : {
					maxWidth: containerMaxWidth + 'px',
					paddingTop: ( displayIcon && iconStyles[ 0 ].icon && iconStyles[ 0 ].margin && iconStyles[ 0 ].margin[ 0 ] && ( iconStyles[ 0 ].margin[ 0 ] < 0 ) ? Math.abs( iconStyles[ 0 ].margin[ 0 ] ) + 'px' : undefined ),
				} ) }>
					<div className="bst-testimonial-text-wrap" style={ ( 'bubble' === style || 'inlineimage' === style ? containerStyles : undefined ) }>
			...
			<div className={ `bst-testimonial-halign-${ hAlign } bst-testimonial-style-${ style } bst-testimonials-media-${ ( displayMedia ? 'on' : 'off' ) } bst-testimonials-icon-${ ( displayIcon ? 'on' : 'off' ) } bst-testimonial-columns-${ columns[ 0 ] } bst-t-xxl-col-${ columns[ 0 ] } bst-t-xl-col-${ columns[ 1 ] } bst-t-lg-col-${ columns[ 2 ] } bst-t-md-col-${ columns[ 3 ] } bst-t-sm-col-${ columns[ 4 ] } bst-t-xs-col-${ columns[ 5 ] } bst-blocks-testimonials-wrap${ uniqueID }` }>
				{ layout && layout === 'carousel' && (
					<div className={ `bst-blocks-carousel bst-carousel-container-dotstyle-${ dotStyle }` }>
						<div className={ `bst-blocks-carousel-init bst-carousel-arrowstyle-${ arrowStyle } bst-carousel-dotstyle-${ dotStyle }` } data-columns-xxl={ columns[ 0 ] } data-columns-xl={ columns[ 1 ] } data-columns-md={ columns[ 2 ] } data-columns-sm={ columns[ 3 ] } data-columns-xs={ columns[ 4 ] } data-columns-ss={ columns[ 5 ] } data-slider-anim-speed={ transSpeed } data-slider-scroll={ slidesScroll } data-slider-arrows={ ( 'none' === arrowStyle ? false : true ) } data-slider-dots={ ( 'none' === dotStyle ? false : true ) } data-slider-hover-pause="false" data-slider-auto={ autoPlay } data-slider-speed={ autoSpeed }>
							{ times( itemsCount, n =>
								<div className="bst-blocks-testimonial-carousel-item" key={ n }>
									{ renderTestimonialPreview( n ) }
								</div>
							) }
						</div>
...
const v_8 = {
	...
	save: ( { attributes } ) => {
		...
		return (
			<div className={ `bst-testimonial-halign-${ hAlign } bst-testimonial-style-${ style } bst-testimonials-media-${ ( displayMedia ? 'on' : 'off' ) } bst-testimonials-icon-${ ( displayIcon ? 'on' : 'off' ) } bst-testimonial-columns-${ columns[ 0 ] } bst-blocks-testimonials-wrap${ uniqueID }` }>
				{ layout && layout === 'carousel' && (
					<div className={ `bst-blocks-carousel bst-carousel-container-dotstyle-${ dotStyle }` }>
						<div className={ `bst-blocks-carousel-init bst-carousel-arrowstyle-${ arrowStyle } bst-carousel-dotstyle-${ dotStyle }` } data-columns-xxl={ columns[ 0 ] } data-columns-xl={ columns[ 1 ] } data-columns-md={ columns[ 2 ] } data-columns-sm={ columns[ 3 ] } data-columns-xs={ columns[ 4 ] } data-columns-ss={ columns[ 5 ] } data-slider-anim-speed={ transSpeed } data-slider-scroll={ slidesScroll } data-slider-arrows={ ( 'none' === arrowStyle ? false : true ) } data-slider-dots={ ( 'none' === dotStyle ? false : true ) } data-slider-hover-pause="false" data-slider-auto={ autoPlay } data-slider-speed={ autoSpeed }>
							{ times( itemsCount, n =>
