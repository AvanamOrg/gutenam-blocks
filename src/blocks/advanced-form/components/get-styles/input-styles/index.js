import { getPreviewSize, BaseColorOutput } from '@base/helpers';
...
export default ( previewDevice, parentFieldStyle ) => {
	...
	styles.color = ( undefined !== parentFieldStyle.color ? BaseColorOutput( parentFieldStyle.color ) : undefined );
	styles.placeholderColor = ( undefined !== parentFieldStyle.placeholderColor ? BaseColorOutput( parentFieldStyle.placeholderColor ) : undefined );
	...
	styles.borderColor = ( undefined === parentFieldStyle.border ? undefined : BaseColorOutput( parentFieldStyle.border, ( parentFieldStyle.borderOpacity !== undefined ? parentFieldStyle.borderOpacity : 1 ) ) );
	styles.boxShadow = ( undefined !== parentFieldStyle.boxShadow && undefined !== parentFieldStyle.boxShadow[ 0 ] && parentFieldStyle.boxShadow[ 0 ] ? ( undefined !== parentFieldStyle.boxShadow[ 7 ] && parentFieldStyle.boxShadow[ 7 ] ? 'inset ' : '' ) + ( undefined !== parentFieldStyle.boxShadow[ 3 ] ? parentFieldStyle.boxShadow[ 3 ] : 1 ) + 'px ' + ( undefined !== parentFieldStyle.boxShadow[ 4 ] ? parentFieldStyle.boxShadow[ 4 ] : 1 ) + 'px ' + ( undefined !== parentFieldStyle.boxShadow[ 5 ] ? parentFieldStyle.boxShadow[ 5 ] : 2 ) + 'px ' + ( undefined !== parentFieldStyle.boxShadow[ 6 ] ? parentFieldStyle.boxShadow[ 6 ] : 0 ) + 'px ' + BaseColorOutput( ( undefined !== parentFieldStyle.boxShadow[ 1 ] ? parentFieldStyle.boxShadow[ 1 ] : '#000000' ), ( undefined !== parentFieldStyle.boxShadow[ 2 ] ? parentFieldStyle.boxShadow[ 2 ] : 1 ) ) : undefined );


	let inputBG, inputGrad, inputGrad2;

	if ( undefined !== parentFieldStyle.backgroundType && 'gradient' === parentFieldStyle.backgroundType ) {
		inputGrad = ( undefined === parentFieldStyle.background ? 'rgba(255,255,255,0)' : BaseColorOutput( parentFieldStyle.background, ( parentFieldStyle.backgroundOpacity !== undefined ? parentFieldStyle.backgroundOpacity : 1 ) ) );
		inputGrad2 = ( undefined !== parentFieldStyle.gradient && undefined !== parentFieldStyle.gradient[ 0 ] && '' !== parentFieldStyle.gradient[ 0 ] ? BaseColorOutput( parentFieldStyle.gradient[ 0 ], ( undefined !== parentFieldStyle.gradient && parentFieldStyle.gradient[ 1 ] !== undefined ? parentFieldStyle.gradient[ 1 ] : 1 ) ) : BaseColorOutput( '#999999', ( undefined !== parentFieldStyle.gradient && parentFieldStyle.gradient[ 1 ] !== undefined ? parentFieldStyle.gradient[ 1 ] : 1 ) ) );
		...
		inputBG = ( undefined === parentFieldStyle.background ? undefined : BaseColorOutput( parentFieldStyle.background, ( parentFieldStyle.backgroundOpacity !== undefined ? parentFieldStyle.backgroundOpacity : 1 ) ) );
	}
