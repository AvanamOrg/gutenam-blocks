...
function FieldEmail( { attributes, setAttributes, isSelected, name  } ) {
	const { required, label, showLabel, value, helpText, width, ariaDescription, placeholder } = attributes;
