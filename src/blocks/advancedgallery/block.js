 ...
 * Import Icons
 */
import { galleryIcon } from '@base/icons';
/**
 * Import Css
 */
 import './style.scss';
 ...
 */
registerBlockType( 'base/advancedgallery', {
	...metadata,
	title: __( 'Advanced Gallery', 'gutenam-blocks' ),
	description: __( 'Photo galleries, carousels, and sliders! Enable custom links, captions, and more.', 'gutenam-blocks' ),
	keywords: [
		__( 'gallery', 'gutenam-blocks' ),
		__( 'image', 'gutenam-blocks' ),
		'BB',
	],
	icon: {
		src: galleryIcon,
		...
		from: [
			{
				...
				transform: ( attributes ) => {
					return createBlock( 'base/advancedgallery', {
