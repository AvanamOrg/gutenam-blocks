...
if ( !class_exists('Base_Puc_Theme_UpdateChecker', false) ):

	class Base_Puc_Theme_UpdateChecker extends Base_Puc_UpdateChecker {
		 ...
		 *
		 * @return Base_Puc_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('Base_Puc_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var Base_Puc_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new Base_Puc_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createInstalledPackage() {
			return new Base_Puc_Theme_Package($this->stylesheet, $this);
		}
	}
