...
if ( !class_exists('Base_Puc_Theme_Update', false) ):

	class Base_Puc_Theme_Update extends Base_Puc_Update {
		public $details_url = '';
		 ...
		 *
		 * @param StdClass|Base_Puc_Theme_Update $object The source object.
		 * @return Base_Puc_Theme_Update The new copy.
		 */
