<?php
if ( !class_exists('Base_Puc_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class Base_Puc_Plugin_UpdateChecker extends Base_Puc_UpdateChecker {
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$this->extraUi = new Base_Puc_Plugin_Ui($this);
		}
		 ...
		 * @return Base_Puc_Scheduler
		 */
		protected function createScheduler($checkPeriod) {
			$scheduler = new Base_Puc_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return Base_Puc_Plugin_Info
		 */
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('Base_Puc_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var Base_Puc_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return Base_Puc_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = Base_Puc_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return Base_Puc_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var Base_Puc_Plugin_Update $update */
		 ...
		 *
		 * @return Base_Puc_InstalledPackage
		 */
		protected function createInstalledPackage() {
			return new Base_Puc_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return Base_Puc_Plugin_Package
		 */
