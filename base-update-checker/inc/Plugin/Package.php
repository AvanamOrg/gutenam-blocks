<?php
if ( !class_exists('Base_Puc_Plugin_Package', false) ):

	class Base_Puc_Plugin_Package extends Base_Puc_InstalledPackage {
		/**
		 * @var Base_Puc_Plugin_UpdateChecker
		 */
		...
		public function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				if (($muPluginDir === false) || ($pluginPath === false)) {
					$muPluginDir = Base_Update_Checker::normalizePath(WPMU_PLUGIN_DIR);
					$pluginPath  = Base_Update_Checker::normalizePath($this->pluginAbsolutePath);
				}
