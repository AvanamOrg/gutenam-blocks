<?php
if ( !class_exists('Base_Puc_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class Base_Puc_Plugin_Update extends Base_Puc_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = Base_Puc_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param Base_Puc_Plugin_Info $info
		 * @return Base_Puc_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|Base_Puc_Plugin_Info|Base_Puc_Plugin_Update $object The source object.
		 * @return Base_Puc_Plugin_Update The new copy.
		 */
