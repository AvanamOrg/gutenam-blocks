<?php
if ( !class_exists('Base_Update_Checker', false) ) :
	 ...
	 * versions by calling {@link Base_Update_Checker::addVersion()}.
	 *
	 * At the moment it can only build instances of the UpdateChecker class. Other classes are
	 * intended mainly for internal use and refer directly to specific implementations.
	 */
	class Base_Update_Checker {
		 ...
		 * @return Base_Puc_Plugin_UpdateChecker|Base_Puc_Theme_UpdateChecker|Base_Puc_Vcs_BaseChecker
		 */
		 ...
		 *
		 * @see Base_Puc_UpdateChecker::__construct
		 *
		 ...
		 * @return Base_Puc_Plugin_UpdateChecker|Base_Puc_Theme_UpdateChecker
		 */
		public static function buildUpdateChecker($metadataUrl, $fullPath, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
			...
			if ( self::isPluginFile($fullPath) ) {
				$type = 'Plugin';
				$id = $fullPath;
				$checkerClass = 'Base_Puc_Plugin_UpdateChecker';
			} else if ( $themeDirectory !== null ) {
				$type = 'Theme';
				$id = $themeDirectory;
				$checkerClass = 'Base_Puc_Theme_UpdateChecker';
			} else {
