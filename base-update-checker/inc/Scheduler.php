<?php
if ( !class_exists('Base_Puc_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see Base_Puc_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class Base_Puc_Scheduler {
		 ...
		 *
		 * @param Base_Puc_UpdateChecker $updateChecker
		...
		public function upgraderProcessComplete(
			...
			if ( is_a($this->updateChecker, 'Base_Puc_Theme_UpdateChecker') ) {
			...
			if ( is_a($this->updateChecker, 'Base_Puc_Plugin_UpdateChecker') ) {
