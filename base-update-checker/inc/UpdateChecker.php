...
if ( !class_exists('Base_Puc_UpdateChecker', false) ):

	abstract class Base_Puc_UpdateChecker {
		...
		/**
		 * @var Base_Puc_InstalledPackage
		 */
		protected $package;

		/**
		 * @var Base_Puc_Scheduler
		 */
		public $scheduler;

		/**
		 * @var Base_Puc_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var Base_Puc_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 2, $optionName = '') {
			...
			$this->upgraderStatus = new Base_Puc_UpgraderStatus();
			$this->updateState = new Base_Puc_StateStore($this->optionName);
		 ...
		 *
		 * @return Base_Puc_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 *
		 * @param Base_Puc_Metadata|null $update
		 */
		protected function fixSupportedWordpressVersion(Base_Puc_Metadata $update = null) {
		 ...
		 * @return array [Base_Puc_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
