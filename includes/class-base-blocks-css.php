...
class Base_Blocks_CSS {
	...
	protected $spacing_sizes = array(
		'xxs' => 'var(--global-bsb-spacing-xxs, 0.5rem)',
		'xs' => 'var(--global-bsb-spacing-xs, 1rem)',
		'sm' => 'var(--global-bsb-spacing-sm, 1.5rem)',
		'md' => 'var(--global-bsb-spacing-md, 2rem)',
		'lg' => 'var(--global-bsb-spacing-lg, 3rem)',
		'xl' => 'var(--global-bsb-spacing-xl, 4rem)',
		'xxl' => 'var(--global-bsb-spacing-xxl, 5rem)',
		'3xl' => 'var(--global-bsb-spacing-3xl, 6.5rem)',
		'4xl' => 'var(--global-bsb-spacing-4xl, 8rem)',
		'5xl' => 'var(--global-bsb-spacing-5xl, 10rem)'
	);
	/**
	 * Font size variables used in string based font sizes.
	 */
	protected $font_sizes = array(
		'sm' => 'var(--global-bsb-font-size-sm, 0.9rem)',
		'md' => 'var(--global-bsb-font-size-md, 1.25rem)',
		'lg' => 'var(--global-bsb-font-size-lg, 2rem)',
		'xl' => 'var(--global-bsb-font-size-xl, 3rem)',
		'xxl' => 'var(--global-bsb-font-size-xxl, 4rem)',
		'3xl' => 'var(--global-bsb-font-size-xxxl, 5rem)',
	);
	/**
	 * Gaps variables used in string based gutters.
	 */
	protected $gap_sizes = array(
		'none' => 'var(--global-bsb-gap-none, 0 )',
		'skinny' => 'var(--global-bsb-gap-sm, 1rem)',
		'narrow' => '20px',
		'wide' => '40px',
		'widest' => '80px',
		'default' => 'var(--global-bsb-gap-md, 2rem)',
		'wider' => 'var(--global-bsb-gap-lg, 4rem)',
		'xs' => 'var(--global-bsb-gap-xs, 0.5rem )',
		'sm' => 'var(--global-bsb-gap-sm, 1rem)',
		'md' => 'var(--global-bsb-gap-md, 2rem)',
		'lg' => 'var(--global-bsb-gap-lg, 4rem)',
	);
	...
	public function frontend_block_css() {
		if ( ! empty( self::$styles ) ) {
			...
			if ( ! empty( $output ) ) {
				wp_register_style( 'base_blocks_css', false );
				wp_enqueue_style( 'base_blocks_css' );
				wp_add_inline_style( 'base_blocks_css', $output );
			}
			if ( ! empty( $custom_output ) ) {
				wp_register_style( 'base_blocks_custom_css', false );
				wp_enqueue_style( 'base_blocks_custom_css' );
				wp_add_inline_style( 'base_blocks_custom_css', $custom_output );
			}
		}
	}
	/**
	...
	public function get_media_queries( $device ) {
		if ( ! isset( $this->media_queries[ $device ] ) ) {
			...
			$media_query['mobileReverse'] = apply_filters( 'base_mobile_reverse_media_query', '(min-width: 768px)' );
			$media_query['tabletOnly']    = apply_filters( 'base_tablet_only_media_query', '(min-width: 768px) and (max-width: 1024px)' );
	...
	public function render_font_family( $font_name, $google = false, $variant = null, $subset = null ) {
		...
		return apply_filters( 'base_blocks_font_family_string', $font_string, $font_name );
	}
	...
	public function css_output() {
		...
		if ( class_exists( 'Base_Blocks_Google_Fonts' ) ) {
			$fonts_instance = Base_Blocks_Google_Fonts::get_instance();
