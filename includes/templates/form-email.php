 ...
 *
 * This template can be overridden by copying it to yourtheme/base-blocks/form-email.php.
 *
 * @version 1.7.0
 */
		...
		<td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
			...
			<div class="footer" style="clear: both; Margin-top: 10px; text-align: center; width: 100%;">
				...
				<tr>
					...
					$footer = sprintf( esc_html__( 'Sent from %s', 'gutenam-blocks' ), '<a href="' . esc_url( home_url() ) . '" style="color: #999999; font-size: 12px; text-align: center; text-decoration: none;">' . wp_specialchars_decode( get_bloginfo( 'name' ) ) . '</a>' );
					echo apply_filters( 'base_blocks_form_email_footer_text', $footer );
					?>
					</td>
				</tr>
				</table>
