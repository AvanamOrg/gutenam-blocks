 ...
 * @category class
 */
class Base_Blocks_Countup_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->set_selector( '.bsb-count-up-' . $unique_id . ' .bsb-count-up-title' );
		...
		$css->set_selector( '.bsb-count-up-' . $unique_id . ' .bsb-count-up-number' );
	...
	public function register_scripts() {
		...
		wp_register_script( 'base-countup', BASE_BLOCKS_URL . 'includes/assets/js/countUp.min.js', array(), GUTENAM_BLOCKS_VERSION, true );
		wp_register_script( 'base-blocks-countup', BASE_BLOCKS_URL . 'includes/assets/js/bsb-countup.min.js', array( 'base-countup' ), GUTENAM_BLOCKS_VERSION, true );

	}
}

Base_Blocks_Countup_Block::get_instance();
