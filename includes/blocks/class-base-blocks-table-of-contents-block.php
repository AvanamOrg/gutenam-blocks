 ...
 * @category class
 */
class Base_Blocks_Tableofcontents_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		// Container.
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ':not(.this-class-is-for-specificity):not(.class-is-for-specificity)' );
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-wrap' );
		...
		// Title.
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-contents-title-wrap' );
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . '.bsb-collapsible-toc.bsb-toc-toggle-hidden .bsb-table-of-contents-title-wrap' );
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-contents-title' );
		if ( isset( $attributes['titleColor'] ) && ! empty( $attributes['titleColor'] ) ) {
			$css->add_property( 'color', $css->render_color( $attributes['titleColor'] ) );
		}
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-wrap .bsb-table-of-content-list' );
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-wrap .bsb-table-of-content-list .bsb-table-of-contents__entry:hover' );
		...
		$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-wrap .bsb-table-of-content-list .active > .bsb-table-of-contents__entry' );
		...
		if ( isset( $attributes['listGap'] ) && is_array( $attributes['listGap'] ) && isset( $attributes['listGap'][0] ) && ! empty( $attributes['listGap'][0] ) ) {
			$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-list li' );
			$css->add_property( 'margin-bottom', $css->render_string( $attributes['listGap'][0], 'px' ) );
			$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-table-of-content-list li .bsb-table-of-contents-list-sub' );
			$css->add_property( 'margin-top', $css->render_string( $attributes['listGap'][0], 'px' ) );
		}
		if ( isset( $attributes['containerBackground'] ) && ! empty( $attributes['containerBackground'] ) ) {
			$css->set_selector( '.bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-basiccircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-basiccircle .bsb-table-of-contents-icon-trigger:before, .bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-arrowcircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-arrowcircle .bsb-table-of-contents-icon-trigger:before, .bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-xclosecircle .bsb-table-of-contents-icon-trigger:after, .bsb-table-of-content-nav.bsb-table-of-content-id' . $unique_id . ' .bsb-toggle-icon-style-xclosecircle .bsb-table-of-contents-icon-trigger:before' );
			$css->add_property( 'background-color', $css->render_color( $attributes['containerBackground'] ) );
		}
	...
	public function build_html( $attributes, $unique_id, $content, $block_instance ) {
		...
		if ( isset( $attributes['enableScrollSpy'] ) && $attributes['enableScrollSpy'] ) {
			wp_register_script( 'base-blocks-gumshoe', BASE_BLOCKS_URL . 'includes/assets/js/gumshoe.min.js', array(), GUTENAM_BLOCKS_VERSION, true );
		}

		$toc = new Base_Blocks_Table_Of_Contents();
	...
	public function register_scripts() {
		...
		wp_register_script( 'base-blocks-' . $this->block_name, BASE_BLOCKS_URL . 'includes/assets/js/bsb-table-of-contents.min.js', array(), GUTENAM_BLOCKS_VERSION, true );
	}
	...
	public function toc_filter_rankmath( $toc_plugins ) {
		$toc_plugins['gutenam-blocks/gutenam-blocks.php'] = 'Gutenam Blocks';
...
Base_Blocks_Tableofcontents_Block::get_instance();
