 ...
 * @category class
 */
class Base_Blocks_Infobox_Block extends Base_Blocks_Abstract_Block {
	/**
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		if ( ! empty( $attributes['bbVersion'] ) && $attributes['bbVersion'] > 1 ) {
			$base_selector = '.bst-info-box' . $unique_id;
		} else {
			$base_selector = '#bst-info-box' . $unique_id;
		}
		...
		$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap' );
		...
		// Hover.
		$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover' );
		// Container Border, check old first.
		...
		if ( isset( $attributes['mediaType'] ) && 'image' === $attributes['mediaType'] ) {
			if ( isset( $media_image['maxWidth'] ) && ! empty( $media_image['maxWidth'] ) ) {
				$css->set_selector( $base_selector . ' .base-info-box-image-inner-intrisic-container' );
				$css->add_property( 'max-width', $media_image['maxWidth'] . 'px' );
			}
			$css->set_selector( $base_selector . ' .base-info-box-image-inner-intrisic-container .base-info-box-image-intrisic' );
		...
		if ( isset( $media_image['subtype'] ) && 'svg+xml' === $media_image['subtype'] ) {
			if ( isset( $media_image['maxWidth'] ) && ! empty( $media_image['maxWidth'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-media .bst-info-box-image' );
			...
			if ( isset( $media_icon['color'] ) && ! empty( $media_icon['color'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-media .bst-info-box-image, ' . $base_selector . ' .bst-blocks-info-box-media .bst-info-box-image path' );
				$css->add_property( 'fill', $media_icon['color'] );
			}
			if ( isset( $media_icon['hoverColor'] ) && ! empty( $media_icon['hoverColor'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-media .bst-info-box-image, ' . $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-media .bst-info-box-image path' );
				$css->add_property( 'fill', $media_icon['hoverColor'] );
			}
		}
		if ( ! empty( $media_icon['size'] ) ) {
			$css->set_selector( $base_selector . ' .bst-info-svg-icon, ' . $base_selector . ' .bst-info-svg-icon-flip, ' . $base_selector . ' .bst-blocks-info-box-number' );
		...
		if ( ( isset( $media_number['family'] ) && ! empty( $media_number['family'] ) ) || ( isset( $media_number['style'] ) && ! empty( $media_number['style'] ) ) || ( isset( $media_number['weight'] ) && ! empty( $media_number['weight'] ) ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-number' );
		...
		$css->set_selector( $base_selector . ' .bst-blocks-info-box-media' );
		if ( isset( $media_icon['color'] ) && ! empty( $media_icon['color'] ) ) {
		...
		if ( isset( $media_style['margin'] ) && is_array( $media_style['margin'] ) && ( ! isset( $attributes['mediaAlign'] ) || 'top' === $attributes['mediaAlign'] ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-media-container' );
			if ( isset( $media_style['margin'][0] ) && is_numeric( $media_style['margin'][0] ) ) {
				$css->add_property( 'margin-top', $media_style['margin'][0] . 'px' );
			}
			if ( isset( $media_style['margin'][1] ) && is_numeric( $media_style['margin'][1] ) ) {
		...
		if ( isset( $media_style['borderRadius'] ) && ! empty( $media_style['borderRadius'] ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-media .base-info-box-image-intrisic img' );
			$css->add_property( 'border-radius', $media_style['borderRadius'] . 'px' );
		}
		$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-media' );
		if ( isset( $media_icon['hoverColor'] ) && ! empty( $media_icon['hoverColor'] ) ) {
		...
		if ( ( ( isset( $attributes['mediaType'] ) && 'icon' === $attributes['mediaType'] || ! isset( $attributes['mediaType'] ) ) && isset( $media_icon['hoverAnimation'] ) && 'drawborder' === $media_icon['hoverAnimation'] ) || ( isset( $attributes['mediaType'] ) && 'number' === $attributes['mediaType'] && isset( $media_number['hoverAnimation'] ) && 'drawborder' === $media_number['hoverAnimation'] ) || ( isset( $attributes['mediaType'] ) && 'image' === $attributes['mediaType'] && isset( $media_image['hoverAnimation'] ) && ( 'drawborder' === $media_image['hoverAnimation'] || 'grayscale-border-draw' === $media_image['hoverAnimation'] ) ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap .bst-blocks-info-box-media' );
			...
			if ( isset( $media_style['borderRadius'] ) && ! empty( $media_style['borderRadius'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap .bst-blocks-info-box-media:before, ' . $base_selector . ' .bst-blocks-info-box-link-wrap .bst-blocks-info-box-media:after' );
				$css->add_property( 'border-radius', $media_style['borderRadius'] . 'px' );
			}
			if ( isset( $media_style['borderWidth'] ) && is_array( $media_style['borderWidth'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap .bst-blocks-info-box-media:before' );
				$css->add_property( 'border-width', $media_style['borderWidth'][0] . 'px' );
			}
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap .bst-blocks-info-box-media:after' );
			$css->set_selector( 'border-width', '0px' );
			if ( isset( $media_style['borderWidth'] ) && is_array( $media_style['borderWidth'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-media:after' );
			...
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-media:before' );
		...
		if ( isset( $attributes['titleColor'] ) || isset( $attributes['titleFont'] ) ) {
			$css->set_selector( $base_selector . ' ' . $titleTag . '.bst-blocks-info-box-title' );
		...
		if ( isset( $attributes['titleHoverColor'] ) && ! empty( $attributes['titleHoverColor'] ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover ' . $titleTag . '.bst-blocks-info-box-title' );
		...
		if ( isset( $attributes['mediaAlignMobile'] ) && ! empty( $attributes['mediaAlignMobile'] ) ) {
			...
			$css->add_property( 'display', 'inline-block' );
			$css->add_property( 'max-width', '100%' );
			// $css .= $base_selector . ' .bst-blocks-info-box-media-align-left.bst-blocks-info-box-link-wrap .bst-blocks-info-box-media {';
			// $css .= 'display: block;';
			// $css .= '}';
			// .bst-blocks-info-box-media-container {
			// 	width: 100%;
			// }
			$css->set_media_state( 'desktop' );
		}
		if ( isset( $attributes['textColor'] ) || isset( $attributes['textFont'] ) || isset( $attributes['textSpacing'] ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-text' );
		...
		if ( isset( $attributes['textHoverColor'] ) && ! empty( $attributes['textHoverColor'] ) ) {
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-text' );
		...
		if ( isset( $attributes['learnMoreStyles'] ) && is_array( $attributes['learnMoreStyles'] ) && is_array( $attributes['learnMoreStyles'][0] ) ) {
			...
			$css->set_selector( $base_selector . ' .bst-blocks-info-box-learnmore' );
			...
			if ( isset( $learn_more_styles['colorHover'] ) || isset( $learn_more_styles['colorHover'] ) || isset( $learn_more_styles['borderHover'] ) ) {
				$css->set_selector( $base_selector . ' .bst-blocks-info-box-link-wrap:hover .bst-blocks-info-box-learnmore' );
...
Base_Blocks_Infobox_Block::get_instance();
