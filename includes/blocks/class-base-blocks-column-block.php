 ...
 * @category class
 */
class Base_Blocks_Column_Block extends Base_Blocks_Abstract_Block {
	/**
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if ( ! empty( $attributes['maxWidth'][0] ) ) {
			$css->set_selector( '.base-column' . $unique_id );
			...
			// $css->set_selector( '.wp-block-base-column>.bst-inside-inner-col>.base-column' . $unique_id );
			// $css->add_property( 'flex', '1 ' . $attributes['maxWidth'][0] . ( isset( $attributes['maxWidthUnit'] ) ? $attributes['maxWidthUnit'] : 'px' ) );
			$css->set_selector( '.wp-block-base-column.bsb-section-dir-horizontal:not(.bsb-section-md-dir-vertical)>.bst-inside-inner-col>.base-column' . $unique_id );
			...
			if ( apply_filters( 'base_blocks_css_output_media_queries', true ) ) {
				...
				$css->set_selector( '.wp-block-base-column.bsb-section-dir-horizontal>.bst-inside-inner-col>.base-column' . $unique_id );
				$css->add_property( 'flex', '0 1 ' . $attributes['maxWidth'][0] . ( isset( $attributes['maxWidthUnit'] ) ? $attributes['maxWidthUnit'] : 'px' ) );
				$css->add_property( 'max-width', 'unset' );
				$css->add_property( 'margin-left', 'unset' );
				$css->add_property( 'margin-right', 'unset' );
		...
		if ( $css->is_number( $attributes['topMargin'] ) || $css->is_number( $attributes['bottomMargin'] ) || $css->is_number( $attributes['rightMargin'] ) || $css->is_number( $attributes['leftMargin'] ) || $css->is_number( $attributes['topMarginT'] ) || $css->is_number( $attributes['bottomMarginT'] ) || $css->is_number( $attributes['rightMarginT'] ) || $css->is_number( $attributes['leftMarginT'] ) || $css->is_number( $attributes['topMarginM'] ) || $css->is_number( $attributes['bottomMarginM'] ) || $css->is_number( $attributes['rightMarginM'] ) || $css->is_number( $attributes['leftMarginM'] ) ) {
			$css->set_selector( '.wp-block-base-column.base-column' . $unique_id . ' > .bst-inside-inner-col' );
			...
			$css->set_selector( '.base-column' . $unique_id . ', .bst-inside-inner-col > .base-column' . $unique_id . ':not(.specificity)' );
		...
		if ( ! empty( $attributes['sticky'] ) && true === $attributes['sticky'] ) {
			...
			if ( ! empty( $attributes['stickyOffset'][0] ) ) {
				$css->set_selector( '.base-column' . $unique_id );
				$css->add_property( '--bsb-section-setting-offset', $attributes['stickyOffset'][0] . ( isset( $attributes['stickyOffsetUnit'] ) ? $attributes['stickyOffsetUnit'] : 'px' ) );
			}
		}
		if ( ! empty( $attributes['stickyOffset'][1] ) ) {
			$css->set_media_state( 'tablet' );
			$css->set_selector( '.base-column' . $unique_id );
			$css->add_property( '--bsb-section-setting-offset', $attributes['stickyOffset'][1] . ( isset( $attributes['stickyOffsetUnit'] ) ? $attributes['stickyOffsetUnit'] : 'px' ) );
			$css->set_media_state( 'desktop' );
		}
		if ( ! empty( $attributes['stickyOffset'][2] ) ) {
			$css->set_media_state( 'mobile' );
			$css->set_selector( '.base-column' . $unique_id );
			$css->add_property( '--bsb-section-setting-offset', $attributes['stickyOffset'][2] . ( isset( $attributes['stickyOffsetUnit'] ) ? $attributes['stickyOffsetUnit'] : 'px' ) );
			$css->set_media_state( 'desktop' );
		}
		if ( ! empty( $attributes['sticky'] ) && true === $attributes['sticky'] ) {
			$css->set_selector( '#wrapper.site' );
		...
		$css->set_selector( '.base-column' . $unique_id . ' > .bst-inside-inner-col' );
		...
		$css->set_selector( '.base-column' . $unique_id . ' > .bst-inside-inner-col,.base-column' . $unique_id . ' > .bst-inside-inner-col:before' );
		...
		$css->set_selector( '.base-column' . $unique_id . ':hover > .bst-inside-inner-col' );
		...
		$css->set_selector( '.base-column' . $unique_id . ':hover > .bst-inside-inner-col,.base-column' . $unique_id . ':hover > .bst-inside-inner-col:before' );
		...
		if ( $desktop_direction === 'horizontal' ) {
			...
			$css->set_selector( '.base-column' . $unique_id . ' > .bst-inside-inner-col > *, .base-column' . $unique_id . ' > .bst-inside-inner-col > figure.wp-block-image, .base-column' . $unique_id . ' > .bst-inside-inner-col > figure.wp-block-base-image' );
			...
			if ( ! empty( $attributes['verticalAlignment'] ) ) {
				...
				$css->add_property( 'display', 'flex' );
				$css->set_selector( '.base-column' . $unique_id . ' > .bst-inside-inner-col > .aligncenter' );
		...
		if ( ! empty( $attributes['verticalAlignment'] ) ) {
			...
			if ( $desktop_direction === 'horizontal' ) {
				$css->set_selector( '.bst-row-column-wrap > .base-column' . $unique_id );
				$css->add_property( 'align-self', $align );
				$css->set_selector( '.bst-inner-column-height-full:not(.bst-has-1-columns) > .wp-block-base-column.base-column' . $unique_id );
				$css->add_property( 'align-self', 'auto' );
				$css->set_selector( '.bst-inner-column-height-full:not(.bst-has-1-columns) > .wp-block-base-column.base-column' . $unique_id . ' > .bst-inside-inner-col' );
				$css->add_property( 'align-items', $align );
			} else {
				$css->set_selector( '.bst-row-column-wrap > .base-column' . $unique_id );
				$css->add_property( 'align-self', $align );
		...
		$css->set_selector( '.base-column' . $unique_id . ' > .bst-inside-inner-col:before' );
		...
		$css->set_selector( '.base-column' . $unique_id . ':hover > .bst-inside-inner-col:before' );
		...
		if ( isset( $attributes['textColor'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ', .base-column' . $unique_id . ' h1, .base-column' . $unique_id . ' h2, .base-column' . $unique_id . ' h3, .base-column' . $unique_id . ' h4, .base-column' . $unique_id . ' h5, .base-column' . $unique_id . ' h6' );
			$css->add_property( 'color', $css->render_color( $attributes['textColor'] ) );
		}
		if ( isset( $attributes['linkColor'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ' a' );
			$css->add_property( 'color', $css->render_color( $attributes['linkColor'] ) );
		}
		if ( isset( $attributes['linkHoverColor'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ' a:hover' );
			$css->add_property( 'color', $css->render_color( $attributes['linkHoverColor'] ) );
		}
		// Hover Text colors.
		if ( isset( $attributes['textColorHover'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ':hover, .base-column' . $unique_id . ':hover h1, .base-column' . $unique_id . ':hover h2, .base-column' . $unique_id . ':hover h3, .base-column' . $unique_id . ':hover h4, .base-column' . $unique_id . ':hover h5, .base-column' . $unique_id . ':hover h6' );
			$css->add_property( 'color', $css->render_color( $attributes['textColorHover'] ) );
		}
		if ( isset( $attributes['linkColorHover'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ':hover a' );
			$css->add_property( 'color', $css->render_color( $attributes['linkColorHover'] ) );
		}
		if ( isset( $attributes['linkHoverColorHover'] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ':hover a:hover' );
		...
		if ( isset( $attributes['collapseOrder'] ) ) {
			$css->set_selector( '.bst-row-column-wrap.bst-tab-layout-three-grid > .base-column' . $unique_id . ', .bst-row-column-wrap.bst-tab-layout-two-grid > .base-column' . $unique_id . ', .bst-row-column-wrap.bst-tab-layout-row > .base-column' . $unique_id );
		...
		if ( ! empty( $attributes['maxWidth'][2] ) ) {
			$css->set_selector( '.base-column' . $unique_id . ', .wp-block-base-column.bsb-section-sm-dir-vertical:not(.bsb-section-sm-dir-horizontal):not(.bsb-section-sm-dir-specificity)>.bst-inside-inner-col>.base-column' . $unique_id );
			...
			$css->set_selector( '.wp-block-base-column.bsb-section-sm-dir-horizontal>.bst-inside-inner-col>.base-column' . $unique_id . ', .wp-block-base-column.bsb-section-dir-horizontal:not(.bsb-section-sm-dir-vertical):not(.bsb-section-md-dir-vertical) >.bst-inside-inner-col>.base-column' . $unique_id );
			...
			$css->set_selector( '.wp-block-base-column.bsb-section-sm-dir-vertical:not(.bsb-section-sm-dir-horizontal):not(.bsb-section-sm-dir-specificity)>.bst-inside-inner-col>.base-column' . $unique_id );
			$css->add_property( 'max-width', $attributes['maxWidth'][1] . ( isset( $attributes['maxWidthUnit'] ) ? $attributes['maxWidthUnit'] : 'px' ) );
			$css->add_property( 'margin-left', 'auto' );
			$css->add_property( 'margin-right', 'auto' );
		...
		if ( isset( $attributes['collapseOrder'] ) ) {
			$css->set_selector( '.bst-row-column-wrap.bst-mobile-layout-three-grid > .base-column' . $unique_id . ', .bst-row-column-wrap.bst-mobile-layout-two-grid > .base-column' . $unique_id . ', .bst-row-column-wrap.bst-mobile-layout-row > .base-column' . $unique_id );
			$css->add_property( 'order', $attributes['collapseOrder'] );
		}
		...
		if ( isset( $attributes['baseBlockCSS'] ) && ! empty( $attributes['baseBlockCSS'] ) ) {
			$css->add_css_string( str_replace( 'selector', '.base-column' . $unique_id, $attributes['baseBlockCSS'] ) );
		}
		return $css->css_output();
	}
}
Base_Blocks_Column_Block::get_instance();
