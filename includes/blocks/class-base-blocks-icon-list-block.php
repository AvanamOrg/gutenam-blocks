 ...
 * @category class
 */
class Base_Blocks_Iconlist_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if ( isset( $attributes['listMargin'] ) && is_array( $attributes['listMargin'] ) && isset( $attributes['listMargin'][0] ) ) {
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ':not(.this-stops-third-party-issues)' );
		...
		$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list:not(.this-prevents-issues):not(.this-stops-third-party-issues):not(.tijsloc)' );
		...
		$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list' );
		...
		if ( ! empty( $attributes['columns'] ) && abs( $attributes['columns'] ) > 1 ) {
			...
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ':not(.bst-svg-icon-list-columns-1) ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap:not(:last-child)' );
		...
		if ( ( ! empty( $attributes['tabletColumns'] ) && abs( $attributes['tabletColumns'] ) > 1 ) || ( empty( $attributes['tabletColumns'] ) && ! empty( $attributes['columns'] ) && abs( $attributes['columns'] ) > 1 ) ) {
			...
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ':not(.bst-tablet-svg-icon-list-columns-1) ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap:not(:last-child)' );
			$css->add_property( 'margin', '0px' );
		}
		if ( ( ! empty( $attributes['mobileColumns'] ) && abs( $attributes['mobileColumns'] ) > 1 ) || ( empty( $attributes['mobileColumns'] ) && ! empty( $attributes['tabletColumns'] ) && abs( $attributes['tabletColumns'] ) > 1 ) || ( empty( $attributes['tabletColumns'] ) && empty( $attributes['mobileColumns'] ) && ! empty( $attributes['columns'] ) && abs( $attributes['columns'] ) > 1 ) ) {
			...
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ':not(.bst-mobile-svg-icon-list-columns-1) ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap:not(:last-child)' );
			$css->add_property( 'margin', '0px' );
		}

		$css->set_media_state( 'desktop' );

		$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ' .bsb-svg-icon-wrap' );
		...
		if ( ! empty( $attributes['listLabelGap'] ) ) {
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap .bst-svg-icon-list-single' );
		...
		if ( isset( $attributes['listStyles'] ) && is_array( $attributes['listStyles'] ) && is_array( $attributes['listStyles'][0] ) ) {
			...
			$css->set_selector( '.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap, .bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list .bst-svg-icon-list-item-wrap a' );
		...
		if( ! empty( $attributes['items'] ) && is_array( $attributes['items'] ) ) {
			foreach( $attributes['items'] as $level => $item ) {
				if( isset( $item['size'] ) && is_numeric( $item['size'] ) ) {
					$css->set_selector( '.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list .bst-svg-icon-list-level-' . $level . ' .bst-svg-icon-list-single svg' );
		...
		if( isset( $attributes['style'] ) && $attributes['style'] === 'stacked' ) {
			$css->set_selector( '.wp-block-base-iconlist.bst-svg-icon-list-items' . $unique_id . ' ul.bst-svg-icon-list .bst-svg-icon-list-single' );
...
Base_Blocks_Iconlist_Block::get_instance();
