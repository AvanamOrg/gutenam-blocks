 ...
 * @category class
 */
class Base_Blocks_Tabs_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		 ...
		 * Container
		 */
		$css->set_selector( '.bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap > .wp-block-base-tab' );
		...
		if ( ! empty( $attributes['titleMargin'] ) && is_array( $attributes['titleMargin'] ) ) {
			$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li' );
		...
		if ( 'vtabs' === $layout && ! empty( $attributes['verticalTabWidth'][0] ) ) {
			$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id );
			$css->add_property( 'display', 'flex' );
			$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list' );
			...
			$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap' );
			$css->add_property( 'float', 'none' );
		...
		if ( 'vtabs' !== $layout && 'percent' === $widthType ) {
			if ( isset( $attributes['gutter'] ) && ! empty( $attributes['gutter'] ) && is_array( $attributes['gutter'] ) ) {
				$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li .bst-tab-title' );
				$css->add_property( 'margin-right', $attributes['gutter'][0] . 'px' );

				if ( is_rtl() ) {
					$css->set_selector( '.rtl .wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li .bst-tab-title' );
					$css->add_property( 'margin-right', '0px' );
			...
			if ( isset( $attributes['tabWidth'] ) && ! empty( $attributes['tabWidth'] ) && is_array( $attributes['tabWidth'] ) && ! empty( $attributes['tabWidth'][1] ) && '' !== $attributes['tabWidth'][1] ) {
				$css->set_media_state( 'tablet' );
				$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list.bsb-tabs-list-columns > li' );
		...
		$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li .bst-tab-title, .wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap > .bst-tabs-accordion-title .bst-tab-title' );
		 ...
		 * Hover
		 */
		$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li .bst-tab-title:hover, .wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap > .bst-tabs-accordion-title .bst-tab-title:hover' );
		 ...
		 * Active
		 */
		$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li.bst-tab-title-active .bst-tab-title, .wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap > .bst-tabs-accordion-title.bst-tab-title-active .bst-tab-title' );
		...
		if ( isset( $attributes['enableSubtitle'] ) && true == $attributes['enableSubtitle'] && isset( $attributes['subtitleFont'] ) && is_array( $attributes['subtitleFont'] ) && is_array( $attributes['subtitleFont'][0] ) ) {
			$css->set_selector( '.bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li .bst-title-sub-text, .bst-tabs-id' . $unique_id . ' > .bst-tabs-content-wrap > .bst-tabs-accordion-title .bst-title-sub-text' );
			$subtitle_font = $attributes['subtitleFont'][0];
		...
		if ( isset( $attributes['titles'] ) && array_filter( array_column( $attributes['titles'], 'icon' ) ) ) {
			$css->set_selector( '.wp-block-base-tabs .bst-tabs-id' . $unique_id . ' > .bst-tabs-title-list li svg' );
	...
	public function register_scripts() {
		...
		wp_register_script( 'base-blocks-' . $this->block_name, BASE_BLOCKS_URL . 'includes/assets/js/bst-tabs.min.js', array(), GUTENAM_BLOCKS_VERSION, true );

	}

}

Base_Blocks_Tabs_Block::get_instance();
