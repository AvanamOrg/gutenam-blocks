 ...
 * @category class
 */
class Base_Blocks_Advancedbtn_Block extends Base_Blocks_Abstract_Block {
	/**
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ', .site .entry-content .wp-block-base-advancedbtn.bst-btns' . $unique_id . ', .wp-block-base-advancedbtn.bsb-btns' . $unique_id . ', .site .entry-content .wp-block-base-advancedbtn.bsb-btns' . $unique_id );
		...
		$css->set_selector( '.wp-block-base-advancedbtn.bsb-btns' . $unique_id );
			...
			foreach ( $attributes['btns'] as $btnkey => $btnvalue ) {
				if ( is_array( $btnvalue ) ) {
					if ( isset( $btnvalue['target'] ) && ! empty( $btnvalue['target'] ) && 'video' == $btnvalue['target'] ) {
						$this->enqueue_style( 'base-simplelightbox-css' );
						$this->enqueue_script( 'base-blocks-videolight-js' );
					}
				}
			}
		}
		if ( isset( $attributes['typography'] ) || isset( $attributes['textTransform'] ) || isset( $attributes['fontWeight'] ) || isset( $attributes['fontStyle'] ) ) {
			$css->set_selector( '.bst-btns' . $unique_id . ' .bst-button' );
		...
		if ( isset( $attributes['btns'] ) && is_array( $attributes['btns'] ) ) {
			foreach ( $attributes['btns'] as $btnkey => $btnvalue ) {
				if ( is_array( $btnvalue ) ) {
					$this->enqueue_style( 'bsb-button-deprecated-styles' );
					if ( isset( $btnvalue['gap'] ) && is_numeric( $btnvalue['gap'] ) ) {
						$css->set_selector( '.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey );
						$css->add_property( 'margin-right', $btnvalue['gap'] . 'px' );

						if ( is_rtl() ) {
							$css->set_selector( '.rtl .bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey );
					...
					$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button' );
					...
					$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button:hover, .wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button:focus' );
					...
					if ( 'gradient' === $bgtype ) {
						$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button::before' );
					...
					if ( isset( $btnvalue['icon'] ) && ! empty( $btnvalue['icon'] ) ) {
						$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button .bst-btn-svg-icon' );
						...
						if ( isset( $btnvalue['iconColorHover'] ) && ! empty( $btnvalue['iconColorHover'] ) ) {
							...
							$css->set_selector( '.wp-block-base-advancedbtn.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-button:hover .bst-btn-svg-icon' );
						...
						if ( isset( $btnvalue['iconPadding'] ) && is_array( $btnvalue['iconPadding'] ) ) {
							$css->set_selector( '.bst-btns' . $unique_id . ' .bst-btn-wrap-' . $btnkey . ' .bst-btn-svg-icon' );
	...
	public function register_scripts() {
		...
		wp_register_style( 'bsb-button-deprecated-styles', BASE_BLOCKS_URL . 'includes/assets/css/bsb-button-deprecated-style.min.css', array(), GUTENAM_BLOCKS_VERSION );
		wp_register_style( 'base-simplelightbox-css', BASE_BLOCKS_URL . 'includes/assets/css/simplelightbox.min.css', array(), GUTENAM_BLOCKS_VERSION );
		wp_register_script( 'base-simplelightbox', BASE_BLOCKS_URL . 'includes/assets/js/simplelightbox.min.js', array(), GUTENAM_BLOCKS_VERSION, true );

		wp_register_script( 'base-blocks-videolight-js', BASE_BLOCKS_URL . 'includes/assets/js/bsb-init-video-popup.min.js', array( 'base-simplelightbox' ), GUTENAM_BLOCKS_VERSION, true );
	}
}

Base_Blocks_Advancedbtn_Block::get_instance();
