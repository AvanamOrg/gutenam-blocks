 ...
 * @category class
 */
class Base_Blocks_Spacer_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if ( ! empty( $attributes['spacerHeight'] ) ) {
			$css->set_selector( '.wp-block-base-spacer.bst-block-spacer-' . $unique_id . ' .bst-block-spacer' );
		...
		if ( ! empty( $attributes['dividerStyle'] ) && 'stripe' === $attributes['dividerStyle'] ) {
			$css->set_selector( '.wp-block-base-spacer.bst-block-spacer-' . $unique_id . ' .bst-divider-stripe' );
			...
			$css->set_selector( '.wp-block-base-spacer.bst-block-spacer-' . $unique_id . ' .bst-divider' );
...
Base_Blocks_Spacer_Block::get_instance();
