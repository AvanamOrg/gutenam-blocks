 ...
 * @category class
 */
class Base_Blocks_Single_Icon_Block extends Base_Blocks_Abstract_Block {
	/**
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if ( isset( $attributes ) && is_array( $attributes ) ) {
			$css->set_selector( '.bst-svg-item-' . $unique_id . ' .bsb-svg-icon-wrap' );
			...
			// Hover.
			$css->set_selector( '.bst-svg-item-' . $unique_id . ':hover .bsb-svg-icon-wrap' );
...
Base_Blocks_Single_Icon_Block::get_instance();
