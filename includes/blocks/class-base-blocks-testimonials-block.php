 ...
 * @category class
 */
class Base_Blocks_Testimonials_Block extends Base_Blocks_Abstract_Block {
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		if ( isset( $attributes['iconStyles'][0] ) && is_array( $attributes['iconStyles'][0] ) ) {
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-svg-testimonial-global-icon' );
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-svg-testimonial-global-icon-wrap' );
		...
		if ( isset( $attributes['testimonials'] ) && is_array( $attributes['testimonials'] ) ) {
			foreach ( $attributes['testimonials'] as $key => $value ) {
				$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-item-' . $key . ' .bst-svg-testimonial-icon' );
		...
		if ( isset( $attributes['ratingStyles'][0] ) && is_array( $attributes['ratingStyles'][0] ) ) {
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-rating-wrap' );
			$css->render_measure_range( $rating_styles, 'margin', 'margin' );
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-rating-wrap .bsb-svg-icon-wrap' );
		...
		$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id );
		 ...
		 */
		if ( isset( $attributes['layout'] ) && 'carousel' === $attributes['layout'] ) {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-blocks-carousel .bst-blocks-testimonial-carousel-item' );
		}
		 ...
		 * columnGap
		 */
		$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-grid-wrap' );
		$css->render_gap( $attributes );

		if ( 'bubble' === $style || 'inlineimage' === $style ) {
			$css->set_selector( '.wp-block-base-testimonials.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-text-wrap:after' );
		...
		if ( 'bubble' !== $style && 'inlineimage' !== $style ){
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-item-wrap' );
		} else {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-item-wrap .bst-testimonial-text-wrap' );
		}
		/* Container Padding */
		...
		if ( $title_font || ( isset( $attributes['titleMinHeight'] ) && is_array( $attributes['titleMinHeight'] ) && isset( $attributes['titleMinHeight'][0] ) && is_numeric( $attributes['titleMinHeight'][0] ) ) ) {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-item-wrap .bst-testimonial-title' );
		...
		if ( $content_font || ( isset( $attributes['contentMinHeight'] ) && is_array( $attributes['contentMinHeight'] ) && isset( $attributes['contentMinHeight'][0] ) && is_numeric( $attributes['contentMinHeight'][0] ) ) ) {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-content' );
		...
		if ( $name_font ) {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-name' );
		...
		if ( isset( $attributes['occupationFont'] ) && is_array( $attributes['occupationFont'] ) && is_array( $attributes['occupationFont'][0] ) ) {
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-occupation' );
		...
		if ( ! isset( $attributes['displayMedia'] ) || ( isset( $attributes['displayMedia'] ) && $attributes['displayMedia'] ) ){
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-media-inner-wrap' );
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-svg-testimonial-icon' );
			$css->add_property( 'justify-content', 'center' );
			$css->add_property( 'align-items', 'center' );

			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-media-inner-wrap .base-testimonial-image-intrisic' );
		...
		if( isset( $attributes['displayRating'] ) && $attributes['displayRating'] ){
			...
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-testimonial-rating-wrap .bst-svg-testimonial-rating-icon' );
		...
		if( isset( $attributes['displayIcon'] ) && $attributes['displayIcon'] ) {
			$css->set_selector( '.bst-blocks-testimonials-wrap' . $unique_id . ' .bst-svg-testimonial-global-icon svg' );
	...
	public function build_html( $attributes, $unique_id, $content, $block_instance ) {
		$css_class = Base_Blocks_CSS::get_instance();
		...
		if ( ! empty( $attributes['bbVersion'] ) && $attributes['bbVersion'] > 1 ) {
			...
			$outer_classes = array( 'bst-blocks-testimonials-wrap' . $unique_id );
			$outer_classes[] = ! empty( $attributes['hAlign'] ) ? 'bst-testimonial-halign-' . $attributes['hAlign'] : 'bst-testimonial-halign-center';
			$outer_classes[] = ! empty( $attributes['style'] ) ? 'bst-testimonial-style-' . $attributes['style'] : 'bst-testimonial-style-basic';
			$outer_classes[] = isset( $attributes['displayMedia'] ) && $attributes['displayMedia'] ? 'bst-testimonials-media-on' : 'bst-testimonials-media-off';
			$outer_classes[] = isset( $attributes['displayIcon'] ) && $attributes['displayIcon'] ? 'bst-testimonials-icon-on' : 'bst-testimonials-icon-off';
			$outer_classes[] = 'bst-testimonial-columns-' . $columns_xxl; // assume column count is the one set for the biggest size.
			$outer_classes[] = 'bst-t-xxl-col-' . $columns_xxl;
			$outer_classes[] = 'bst-t-xl-col-' . $columns_xl;
			$outer_classes[] = 'bst-t-lg-col-' . $columns_md;
			$outer_classes[] = 'bst-t-md-col-' . $columns_sm;
			$outer_classes[] = 'bst-t-sm-col-' . $columns_xs;
			$outer_classes[] = 'bst-t-xs-col-' . $columns_ss;

			$inner_classes = array( 'bst-blocks-testimonials-inner-wrap' );
			$inner_classes[] = ! empty( $attributes['layout'] ) && 'carousel' === $attributes['layout'] ? 'bst-blocks-carousel' : 'bst-testimonial-grid-wrap';
			if ( ! empty( $attributes['layout'] ) && 'carousel' === $attributes['layout'] ) {
				$inner_classes[] = 'bst-carousel-container-dotstyle-' . $dot_style;
				$inner_classes[] = 'bst-carousel-container-arrowstyle-' . $arrow_style;
				...
				$carousel_content .= '<div class="bst-blocks-carousel-init bsb-gallery-carousel bst-carousel-arrowstyle-' . esc_attr( $arrow_style ) . ' bst-carousel-dotstyle-' . esc_attr( $dot_style ) . '" data-columns-xxl="' . esc_attr( $columns_xxl ) . '" data-columns-xl="' . esc_attr( $columns_xl ) . '" data-columns-md="' . esc_attr( $columns_md ) . '" data-columns-sm="' . esc_attr( $columns_sm ) . '" data-columns-xs="' . esc_attr( $columns_xs ) . '" data-columns-ss="' . esc_attr( $columns_ss ) . '" data-slider-anim-speed="' . esc_attr( $trans_speed ) . '" data-slider-scroll="' . esc_attr( $slides_sc ) . '" data-slider-arrows="' . esc_attr( 'none' === $arrow_style ? 'false' : 'true' ) . '" data-slider-dots="' . esc_attr( 'none' === $dot_style ? 'false' : 'true' ) . '" data-slider-hover-pause="false" data-slider-auto="' . esc_attr( $autoplay ) . '" data-slider-speed="' . esc_attr( $auto_speed ) . '" data-slider-gap="' . esc_attr( $this->get_usable_value( $css_class, $gap, $gap_unit ) ) . '" data-slider-gap-tablet="' . esc_attr( $this->get_usable_value( $css_class, $tablet_gap, $gap_unit ) ) . '" data-slider-gap-mobile="' . esc_attr( $this->get_usable_value( $css_class, $mobile_gap, $gap_unit ) ) . '">';
...
Base_Blocks_Testimonials_Block::get_instance();
