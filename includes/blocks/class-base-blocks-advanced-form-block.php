 ...
 * @category class
 */
class Base_Blocks_Advanced_Form_Block extends Base_Blocks_Abstract_Block {
	/**
	...
	public function build_css( $attributes, $css, $unique_id, $unique_style_id ) {
		...
		// Container
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id );
		...
		// Input Styles
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id . ' .bsb-advanced-form-field' );
		 ...
		 */
		$css->set_selector(
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=text],' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=tel],' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=number],' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=date],' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=time],' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=email],' .
			'.wp-block-base-advanced-form' . $unique_id . ' select,' .
			'.wp-block-base-advanced-form' . $unique_id . ' textarea'
		);
		 ...
		 */
		$css->set_selector(
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=text]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=tel]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=number]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=date]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=time]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=email]::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' select::placeholder,' .
			'.wp-block-base-advanced-form' . $unique_id . ' textarea::placeholder'
		);
		 ...
		 */
		$css->set_selector(
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=text]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=email]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=tel]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=date]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=number]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' input[type=time]:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' select:focus,' .
			'.wp-block-base-advanced-form' . $unique_id . ' textarea:focus'
		);
		 ...
		 *
		 */
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id . ' .bsb-advanced-form-label' );
		 ...
		 *
		 */
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id . ' .bsb-advanced-form-label .bsb-advanced-form-required' );
		 ...
		 *
		 */
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id . ' .bsb-form-field-help' );
		 ...
		 *
		 */
		$css->set_selector( '.wp-block-base-advanced-form' . $unique_id . ' .bsb-advanced-form-submit .bsb-advanced-form-submit-button' );
		...
		if ( is_array( $post_meta ) ) {
			foreach ( $post_meta as $meta_key => $meta_value ) {
				if ( strpos( $meta_key, '_bst_form_' ) === 0 && isset( $meta_value[0] ) ) {
					$form_meta[ str_replace( '_bst_form_', '', $meta_key ) ] = maybe_unserialize( $meta_value[0] );
				}
			}
		}
	...
	public function register_scripts() {
		...
		if ( $this->has_script ) {
			wp_register_script( 'base-blocks-' . $this->block_name, BASE_BLOCKS_URL . 'includes/assets/js/bsb-advanced-form-block.min.js', array(), GUTENAM_BLOCKS_VERSION, true );
		}
	}
}

Base_Blocks_Advanced_Form_Block::get_instance();
