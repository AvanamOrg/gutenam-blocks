...
class Base_Blocks_Form_CPT_Controller extends WP_REST_Posts_Controller {
	/**
	...
	public function get_items_permissions_check( $request ) {
		if ( ! current_user_can( get_post_type_object( $this->post_type )->cap->edit_posts ) ) {
			return new WP_Error( 'rest_cannot_view', __( 'You do not have permission to view these posts.', 'gutenam-blocks' ) );
		}
...
add_action( 'init', function () {
	register_post_type( 'base_form', array(
		'public'                => false,
		'show_in_menu'          => 'gutenam-blocks',
		'show_ui'               => true,
		'show_in_rest'          => true,
		'rest_controller_class' => Base_Blocks_Form_CPT_Controller::class,
		'supports'              => array( 'title', 'editor', 'author', 'custom-fields', 'revisions' ),
		'taxonomies'            => array( 'post_tag' ),
		'template'              => array(
			array( 'base/advanced-form' )
		),
//		'template_lock'         => 'insert',
		...
		'labels'                => array(
			'name'               => _x( 'Forms', 'Post Type General Name', 'base_blocks' ),
			'singular_name'      => _x( 'Form', 'Post Type Singular Name', 'base_blocks' ),
			'menu_name'          => __( 'Forms', 'base_blocks' ),
			'menu_name'          => _x( 'Forms', 'Admin Menu text', 'base_blocks' ),
			'archives'           => __( 'Form Archives', 'base_blocks' ),
			'attributes'         => __( 'Form Attributes', 'base_blocks' ),
			'parent_item_colon'  => __( 'Parent Form:', 'base_blocks' ),
			'all_items'          => __( 'All Forms', 'base_blocks' ),
			'add_new_item'       => __( 'Add New Form', 'base_blocks' ),
			'new_item'           => __( 'New Form', 'base_blocks' ),
			'edit_item'          => __( 'Edit Form', 'base_blocks' ),
			'update_item'        => __( 'Update Form', 'base_blocks' ),
			'view_item'          => __( 'View Form', 'base_blocks' ),
			'view_items'         => __( 'View Forms', 'base_blocks' ),
			'search_items'       => __( 'Search Forms', 'base_blocks' ),
			'not_found'          => __( 'Not found', 'base_blocks' ),
			'not_found_in_trash' => __( 'Not found in Trash', 'base_blocks' ),
			'filter_items_list'  => __( 'Filter items list', 'base_blocks' ),
		)
	) );
	...
	$margin_padding_keys = array(
		'_bst_form_marginDesktop',
		'_bst_form_marginTablet',
		'_bst_form_marginMobile',
		'_bst_form_paddingDesktop',
		'_bst_form_paddingTablet',
		'_bst_form_paddingMobile',
	);
...
add_filter( 'default_content', function ( string $content, \WP_Post $post ) {
	if ( $post->post_type === 'base_form' ) {
		return serialize_block( [
			'blockName'    => 'base/advanced-form',
			'innerContent' => [],
			'attrs'        => [],
		] );
	}
